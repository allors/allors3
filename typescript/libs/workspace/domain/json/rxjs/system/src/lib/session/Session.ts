import { IChangeSet, IInvokeResult, InvokeOptions, IObject, IPullResult, IPushResult, ISession, ISessionServices, Method, Procedure, Pull } from '@allors/workspace/system';
import { AssociationType, Class, Composite, Origin, RoleType } from '@allors/workspace/system';
