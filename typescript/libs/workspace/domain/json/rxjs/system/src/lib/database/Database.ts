...
import { IWorkspace, IWorkspaceServices, Operations } from '@allors/workspace/system';
import { Class, MethodType, OperandType, RelationType } from '@allors/workspace/system';
