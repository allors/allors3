import { SyncResponseObject, SyncResponseRole, unitFromJson } from '@allors/protocol/json/system';
import { Class, RelationType, RoleType } from '@allors/workspace/system';
