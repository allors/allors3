import { Pull, IPromiseApi, IWorkspace } from '@allors/workspace/domain/system';
...
export async function initAssociation(client: IPromiseApi, workspace: IWorkspace, login: (login: string) => Promise<boolean>) {
