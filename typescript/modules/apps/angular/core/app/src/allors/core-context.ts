...
import { IConfiguration, IDatabaseClient, IInvokeResult, InvokeOptions, IObject, IPullResult, IResult, ISession, IWorkspace, Method, Pull } from '@allors/workspace/domain/system';
