import { angularList, angularOverview, angularMenu, angularFilterDefinition, FilterDefinition, angularSorter, Sorter, SearchFactory } from '@allors/workspace/angular/base';
