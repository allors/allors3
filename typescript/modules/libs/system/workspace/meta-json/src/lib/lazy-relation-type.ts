...
import { AssociationType, Multiplicity, ObjectType, Origin, RelationType, RoleType } from '@allors/workspace/meta/system';
...
export class LazyRelationType implements RelationType {
  ...
  constructor(associationObjectType: InternalComposite, data: RelationTypeData, lookup: Lookup) {
    ...
    const [t, r] = data;
    const roleObjectType = this.metaPopulation.metaObjectByTag.get(r) as ObjectType;
