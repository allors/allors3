...
export class ObjectServiceCore extends ObjectService {
  constructor(
    ...
    @Inject(OBJECT_CREATE_TOKEN)
    private createControlByObjectTypeTag: { [id: string]: any },
    @Inject(OBJECT_EDIT_TOKEN)
    private editControlByObjectTypeTag: { [id: string]: any }
  ) {
    super();
  }
