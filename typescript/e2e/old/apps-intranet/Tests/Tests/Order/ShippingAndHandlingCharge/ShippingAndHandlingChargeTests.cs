...
namespace Tests.OrderAdjustmentTests
{
    ...
    public class ShippingAndHandlingChargeEditTests : Test, IClassFixture<Fixture>
    {
        ...
        public ShippingAndHandlingChargeEditTests(Fixture fixture)
            : base(fixture)
        {
            this.Login();
        }
        ...
        public void EditForProductQuote()
        {
            ...
            quote.AddOrderAdjustment(new ShippingAndHandlingChargeBuilder(this.Transaction).WithAmountDefaults().Build());
            ...
            var expected = new ShippingAndHandlingChargeBuilder(this.Transaction).WithAmountDefaults().Build();
            ...
            var actual = (ShippingAndHandlingCharge)this.Transaction.Instantiate(id);
        ...
        public void EditForSalesOrder()
        {
            ...
            salesOrder.AddOrderAdjustment(new ShippingAndHandlingChargeBuilder(this.Transaction).WithAmountDefaults().Build());
        ...
        public void EditForSalesInvoice()
        {
            ...
            salesInvoice.AddOrderAdjustment(new ShippingAndHandlingChargeBuilder(this.Transaction).WithAmountDefaults().Build());
        ...
        public void EditForPurchaseInvoice()
        {
            ...
            purchaseInvoice.AddOrderAdjustment(new ShippingAndHandlingChargeBuilder(this.Transaction).WithAmountDefaults().Build());
