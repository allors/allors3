...
namespace Tests.OrderAdjustmentTests
{
    ...
    public class MiscellaneousChargeCreateTests : Test, IClassFixture<Fixture>
    {
        ...
        public MiscellaneousChargeCreateTests(Fixture fixture)
            : base(fixture)
        {
            this.Login();
        }
        ...
        public void CreateAmountForProductQuote()
        {
            ...
            var before = new MiscellaneousCharges(this.Transaction).Extent().ToArray();
            ...
            var miscellaneousChargeCreate = new ProductQuoteOverviewComponent(this.quoteListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateMiscellaneousCharge();
            ...
            var after = new MiscellaneousCharges(this.Transaction).Extent().ToArray();
        ...
        public void CreatePercentageForProductQuote()
        {
            ...
            var expected = new MiscellaneousChargeBuilder(this.Transaction).WithPercentageDefaults().Build();
            quote.AddOrderAdjustment(expected);
        ...
        public void CreateAmountForSalesOrder()
        {
            ...
            var miscellaneousChargeCreate = new SalesOrderOverviewComponent(this.salesOrderListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateMiscellaneousCharge();
        ...
        public void CreateAmountForSalesInvoice()
        {
            ...
            var miscellaneousChargeCreate = new SalesInvoiceOverviewComponent(this.salesInvoiceListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateMiscellaneousCharge();
        ...
        public void CreateAmountForPurchaseInvoice()
        {
            ...
            var miscellaneousChargeCreate = new PurchaseInvoiceOverviewComponent(this.purchaseInvoiceListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateMiscellaneousCharge();
