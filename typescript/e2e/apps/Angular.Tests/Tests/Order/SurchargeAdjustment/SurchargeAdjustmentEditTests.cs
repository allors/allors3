...
namespace Tests.OrderAdjustmentTests
{
    ...
    public class SurchargeAdjustmentEditTests : Test, IClassFixture<Fixture>
    {
        ...
        public SurchargeAdjustmentEditTests(Fixture fixture)
            : base(fixture)
        {
            this.Login();
        }
        ...
        public void EditForProductQuote()
        {
            ...
            quote.AddOrderAdjustment(new SurchargeAdjustmentBuilder(this.Transaction).WithAmountDefaults().Build());
            ...
            var actual = (SurchargeAdjustment)this.Transaction.Instantiate(id);
        ...
        public void EditForSalesOrder()
        {
            ...
            salesOrder.AddOrderAdjustment(new SurchargeAdjustmentBuilder(this.Transaction).WithAmountDefaults().Build());
        ...
        public void EditForSalesInvoice()
        {
            ...
            salesInvoice.AddOrderAdjustment(new SurchargeAdjustmentBuilder(this.Transaction).WithAmountDefaults().Build());
        ...
        public void EditForPurchaseInvoice()
        {
            ...
            purchaseInvoice.AddOrderAdjustment(new SurchargeAdjustmentBuilder(this.Transaction).WithAmountDefaults().Build());
