...
namespace Tests.OrderAdjustmentTests
{
    ...
    public class FeeCreateTests : Test, IClassFixture<Fixture>
    {
        ...
        public void CreateAmountForProductQuote()
        {
            ...
            var before = new Fees(this.Transaction).Extent().ToArray();
            ...
            var after = new Fees(this.Transaction).Extent().ToArray();
        ...
        public void CreatePercentageForProductQuote()
        {
            ...
            var expected = new FeeBuilder(this.Transaction).WithPercentageDefaults().Build();
            quote.AddOrderAdjustment(expected);
