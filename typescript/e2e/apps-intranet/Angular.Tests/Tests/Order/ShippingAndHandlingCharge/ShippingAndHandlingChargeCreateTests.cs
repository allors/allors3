...
namespace Tests.OrderAdjustmentTests
{
    ...
    public class ShippingAndHandlingChargeCreateTests : Test, IClassFixture<Fixture>
    {
        ...
        public void CreateAmountForProductQuote()
        {
            ...
            var before = new ShippingAndHandlingCharges(this.Transaction).Extent().ToArray();
            ...
            var after = new ShippingAndHandlingCharges(this.Transaction).Extent().ToArray();
        ...
        public void CreatePercentageForProductQuote()
        {
            ...
            var expected = new ShippingAndHandlingChargeBuilder(this.Transaction).WithPercentageDefaults().Build();
            quote.AddOrderAdjustment(expected);
