...
namespace Tests.OrderAdjustmentTests
{
   ...
   using Xunit;
    ...
    public class DiscountAdjustmentCreateTests : Test, IClassFixture<Fixture>
    {
        ...
        public DiscountAdjustmentCreateTests(Fixture fixture)
            : base(fixture)
        {
            this.Login();
        }
        ...
        public void CreateAmountForProductQuote()
        {
            ...
            var before = new DiscountAdjustments(this.Transaction).Extent().ToArray();

            var expected = new DiscountAdjustmentBuilder(this.Transaction).WithAmountDefaults().Build();
            ...
            var discountAdjustmentCreate = new ProductQuoteOverviewComponent(this.quoteListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateDiscountAdjustment();
            ...
            var after = new DiscountAdjustments(this.Transaction).Extent().ToArray();
        ...
        public void CreatePercentageForProductQuote()
        {
            ...
            var expected = new DiscountAdjustmentBuilder(this.Transaction).WithPercentageDefaults().Build();
            quote.AddOrderAdjustment(expected);
        ...
        public void CreateAmountForSalesOrder()
        {
            ...
            var discountAdjustmentCreate = new SalesOrderOverviewComponent(this.salesOrderListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateDiscountAdjustment();
        ...
        public void CreateAmountForSalesInvoice()
        {
            ...
            var discountAdjustmentCreate = new SalesInvoiceOverviewComponent(this.salesInvoiceListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateDiscountAdjustment();
        ...
        public void CreateAmountForPurchaseInvoice()
        {
            ...
            var discountAdjustmentCreate = new PurchaseInvoiceOverviewComponent(this.purchaseInvoiceListPage.Driver, this.M).OrderadjustmentOverviewPanel.Click().CreateDiscountAdjustment();
