...
namespace Components
{
    ...
    public static partial class ComponentExtensions
    {
        ...
        public static MatList<T> MatList<T>(this T @this, By selector = null) where T : Component => new MatList<T>(@this, @this.M, selector);
        ...
        public static MatTable<T> MatTable<T>(this T @this, By selector = null) where T : Component => new MatTable<T>(@this, @this.M, selector);
