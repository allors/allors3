...
namespace Components
{
    ...
    public class MatSelect : SelectorComponent
    {
        public MatSelect(IWebDriver driver, MetaPopulation m, RoleType roleType, params string[] scopes) : base(driver, m)
        {
            ...
            this.ValueTextSelector = new ByChained(this.Selector, By.XPath($".//mat-select[@data-allors-roletype='{roleType.RelationType.Tag}']/*[contains(@class,'mat-select-value-text')]"));
        }
