...
export class AccountingTransactionListPage {
  readonly page: Page;
  ...
  async goto(): Promise<void> {
    await this.page.goto('/accounting/accountingtransactions');
  }

  async waitForPage(): Promise<void> {
    await this.page.waitForURL('**/accounting/accountingtransactions');
