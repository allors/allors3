...
import { CatalogueListPage } from '../../pages/products/catalogue-list.page';

test.describe('Catalogue List', () => {
  test('should display catalogue list page with table', async ({
    authenticatedPage,
  }) => {
    const listPage = new CatalogueListPage(authenticatedPage);
    await listPage.goto();
