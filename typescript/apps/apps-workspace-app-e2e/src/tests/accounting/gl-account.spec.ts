...
import { GeneralLedgerAccountListPage } from '../../pages/accounting/general-ledger-account-list.page';

test.describe('General Ledger Account List', () => {
  test('should display GL account list page with table', async ({
    authenticatedPage,
  }) => {
    const listPage = new GeneralLedgerAccountListPage(authenticatedPage);
    await listPage.goto();
