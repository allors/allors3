...
import { ShipmentListPage } from '../../pages/shipment/shipment-list.page';

test.describe('Shipment List', () => {
  test('should display shipment list page with table', async ({
    authenticatedPage,
  }) => {
    const listPage = new ShipmentListPage(authenticatedPage);
    await listPage.goto();
