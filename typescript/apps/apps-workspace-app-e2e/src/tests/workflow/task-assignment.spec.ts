...
import { TaskAssignmentListPage } from '../../pages/workflow/task-assignment-list.page';

test.describe('Task Assignment List', () => {
  test('should display task assignment list page with table', async ({
    authenticatedPage,
  }) => {
    const listPage = new TaskAssignmentListPage(authenticatedPage);
    await listPage.goto();
