...
import {
  ...
  VatClauseListPageComponent,
  VatRegimeListPageComponent,
  VatRegimeOverviewPageComponent,
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'irpfregime/:id',
            component: IrpfRegimeOverviewPageComponent,
          },
          { path: 'vatregimes', component: VatRegimeListPageComponent },
          { path: 'vatregime/:id', component: VatRegimeOverviewPageComponent },
          { path: 'vatclauses', component: VatClauseListPageComponent },
        ],
      },
    ],
  },
