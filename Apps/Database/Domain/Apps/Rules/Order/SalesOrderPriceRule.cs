    ...
    public class SalesOrderPriceRule : Rule
    {
        public SalesOrderPriceRule(M m) : base(m, new Guid("aa490071-772f-400d-a799-3f015e877c05")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalOrderAdjustment) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalDiscountAsPercentage) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalSurchargeAsPercentage) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalExVat) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalVat) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalIncVat) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.TotalIrpf) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new RolePattern(m.SalesOrderItem, m.SalesOrderItem.GrandTotal) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
            };
