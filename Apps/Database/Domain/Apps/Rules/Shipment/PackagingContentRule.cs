...
namespace Allors.Database.Domain
{
    ...
    {
        public PackagingContentRule(M m) : base(m, new Guid("E6D43FBC-8501-4BEA-83D3-4034657E0D3A")) =>
            this.Patterns = new Pattern[]
        {
            new RolePattern(m.PackagingContent, m.PackagingContent.ShipmentItem),
            new RolePattern(m.ShipmentItem, m.ShipmentItem.Quantity) { Steps = new IPropertyType[] { m.ShipmentItem.PackagingContentsWhereShipmentItem } },
            new RolePattern(m.ShipmentItem, m.ShipmentItem.QuantityShipped) { Steps = new IPropertyType[] { m.ShipmentItem.PackagingContentsWhereShipmentItem } },
        };
