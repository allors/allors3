...
namespace Allors.Database.Domain
{
    ...
    {
        public PurchaseShipmentStateRule(M m) : base(m, new Guid("f5a01c30-1f20-4dba-a828-a32ab38d28de")) =>
            this.Patterns = new Pattern[]
            {
                new RolePattern(m.ShipmentReceipt, m.ShipmentReceipt.QuantityAccepted) { Steps = new IPropertyType[] { m.ShipmentReceipt.ShipmentItem, m.ShipmentItem.ShipmentWhereShipmentItem }, OfType = m.PurchaseShipment.Class },
                new RolePattern(m.ShipmentItem, m.ShipmentItem.ShipmentItemState) { Steps = new IPropertyType[] { m.ShipmentItem.ShipmentWhereShipmentItem }, OfType = m.PurchaseShipment.Class },
            };
