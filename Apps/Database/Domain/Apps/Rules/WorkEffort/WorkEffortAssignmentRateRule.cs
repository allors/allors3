...
namespace Allors.Database.Domain
{
    ...
    public class WorkEffortAssignmentRateRule : Rule
    {
        public WorkEffortAssignmentRateRule(MetaPopulation m) : base(m, new Guid("a733672e-cbd8-4816-b628-0ab9bdd55703")) =>
