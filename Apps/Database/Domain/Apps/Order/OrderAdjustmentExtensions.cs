...
namespace Allors.Domain
{
    ...
    {
        public static void AppsOnPreDerive(this OrderAdjustment @this, ObjectOnPreDerive method)
        {
        ...
        public static void AppsOnDerive(this OrderAdjustment @this, ObjectOnDerive method)
        {
