...
namespace Allors.Database.Domain
{
    ...
    public class PickListStateDerivation : DomainDerivation
    {
        public PickListStateDerivation(M m) : base(m, new Guid("71f5e0b8-a050-4e6f-8562-8b072a94ca58")) =>
            ...
            {
                new ChangedPattern(m.Shipment.ShipmentState) { Steps = new IPropertyType[] { m.Shipment.ShipmentItems, m.ShipmentItem.ItemIssuancesWhereShipmentItem, m.ItemIssuance.PickListItem, m.PickListItem.PickListWherePickListItem } },
            };
