...
namespace Allors.Database.Domain
{
    ...
    public class SalesOrderPriceDerivation : DomainDerivation
    {
        public SalesOrderPriceDerivation(M m) : base(m, new Guid("aa490071-772f-400d-a799-3f015e877c05")) =>
            ...
            {
                new AssociationPattern(this.M.SalesOrder.DerivationTrigger),
                ...
                new AssociationPattern(this.M.SalesOrder.OrderAdjustments),
                new AssociationPattern(this.M.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.SalesOrder.Class },
                new AssociationPattern(this.M.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.SalesOrder.Class },
                new AssociationPattern(this.M.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.SalesOrder.Class },
                new AssociationPattern(this.M.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.SalesOrder.Class },
                new AssociationPattern(this.M.SalesOrderItem.TotalBasePrice) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalDiscount) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalSurcharge) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalOrderAdjustment) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalDiscountAsPercentage) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalSurchargeAsPercentage) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalExVat) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalVat) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalIncVat) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.TotalIrpf) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
                new AssociationPattern(this.M.SalesOrderItem.GrandTotal) { Steps =  new IPropertyType[] {m.SalesOrderItem.SalesOrderWhereSalesOrderItem} },
            };
