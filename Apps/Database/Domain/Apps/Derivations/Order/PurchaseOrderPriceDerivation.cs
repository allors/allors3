...
namespace Allors.Database.Domain
{
    ...
    public class PurchaseOrderPriceDerivation : DomainDerivation
    {
        public PurchaseOrderPriceDerivation(M m) : base(m, new Guid("b553564c-45e1-495c-975a-90eb6fc67d5d")) =>
            ...
            {
                new RolePattern(m.PurchaseOrder.DerivationTrigger),
                new RolePattern(m.PurchaseOrder.ValidOrderItems),
                new RolePattern(m.PurchaseOrder.TakenViaSupplier),
                new RolePattern(m.PurchaseOrder.OrderAdjustments),
                new RolePattern(m.PurchaseOrderItem.Part) { Steps =  new IPropertyType[] {m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem } },
                new RolePattern(m.PurchaseOrderItem.QuantityOrdered) { Steps =  new IPropertyType[] {m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem } },
                new RolePattern(m.PurchaseOrderItem.AssignedUnitPrice) { Steps =  new IPropertyType[] {m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem } },
                new RolePattern(m.PurchaseOrderItem.DiscountAdjustments) { Steps =  new IPropertyType[] {m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem } },
                new RolePattern(m.PurchaseOrderItem.SurchargeAdjustments) { Steps =  new IPropertyType[] {m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem } },
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.PurchaseOrderItem.PurchaseOrderWherePurchaseOrderItem}, OfType = m.PurchaseOrder.Class },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.OrderWhereOrderAdjustment}, OfType = m.PurchaseOrder.Class },
            };
