    ...
    public class QuoteItemPriceDerivation : DomainDerivation
    {
        public QuoteItemPriceDerivation(M m) : base(m, new Guid("01b4ac5d-fbd9-4f94-a1cf-2f5b5875063f")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new AssociationPattern(this.M.QuoteItem.QuotedWithFeatures),
                new AssociationPattern(this.M.QuoteItem.Quantity),
                new AssociationPattern(this.M.QuoteItem.AssignedUnitPrice),
                new AssociationPattern(this.M.QuoteItem.DiscountAdjustments),
                new AssociationPattern(this.M.QuoteItem.SurchargeAdjustments),
                new AssociationPattern(this.M.QuoteItem.VatRate),
                new AssociationPattern(this.M.QuoteItem.IrpfRate),
                new AssociationPattern(this.M.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.QuoteItem.Class },
                new AssociationPattern(this.M.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.QuoteItem.Class },
                new AssociationPattern(this.M.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.QuoteItem.Class },
                new AssociationPattern(this.M.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.QuoteItem.Class },
                new AssociationPattern(this.M.Quote.Receiver) { Steps =  new IPropertyType[] {m.Quote.QuoteItems } },
                new AssociationPattern(this.M.Quote.IssueDate) { Steps =  new IPropertyType[] {m.Quote.QuoteItems } },
                new AssociationPattern(this.M.Quote.DerivationTrigger) { Steps =  new IPropertyType[] {m.Quote.QuoteItems } },
                new AssociationPattern(this.M.ProductQuoteItemByProduct.Product) { Steps =  new IPropertyType[] {m.ProductQuoteItemByProduct.ProductQuoteWhereProductQuoteItemsByProduct, m.Quote.QuoteItems } },
                new AssociationPattern(this.M.ProductQuoteItemByProduct.QuantityOrdered) { Steps =  new IPropertyType[] {m.ProductQuoteItemByProduct.ProductQuoteWhereProductQuoteItemsByProduct, m.Quote.QuoteItems } },
                new AssociationPattern(this.M.ProductQuoteItemByProduct.ValueOrdered) { Steps =  new IPropertyType[] {m.ProductQuoteItemByProduct.ProductQuoteWhereProductQuoteItemsByProduct, m.Quote.QuoteItems } },
            };
