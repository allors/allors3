    ...
    public class QuoteItemPriceDerivation : DomainDerivation
    {
        public QuoteItemPriceDerivation(M m) : base(m, new Guid("01b4ac5d-fbd9-4f94-a1cf-2f5b5875063f")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new RolePattern(m.QuoteItem.QuotedWithFeatures),
                new RolePattern(m.QuoteItem.Quantity),
                new RolePattern(m.QuoteItem.AssignedUnitPrice),
                new RolePattern(m.QuoteItem.DiscountAdjustments),
                new RolePattern(m.QuoteItem.SurchargeAdjustments),
                new RolePattern(m.QuoteItem.VatRate),
                new RolePattern(m.QuoteItem.IrpfRate),
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.QuoteItem.Class },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.QuoteItem.Class },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.QuoteItem.Class },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.QuoteItem.Class },
                new RolePattern(m.Quote.Receiver) { Steps =  new IPropertyType[] {m.Quote.QuoteItems } },
                new RolePattern(m.Quote.IssueDate) { Steps =  new IPropertyType[] {m.Quote.QuoteItems } },
                new RolePattern(m.Quote.DerivationTrigger) { Steps =  new IPropertyType[] {m.Quote.QuoteItems } },
                new RolePattern(m.ProductQuoteItemByProduct.Product) { Steps =  new IPropertyType[] {m.ProductQuoteItemByProduct.ProductQuoteWhereProductQuoteItemsByProduct, m.Quote.QuoteItems } },
                new RolePattern(m.ProductQuoteItemByProduct.QuantityOrdered) { Steps =  new IPropertyType[] {m.ProductQuoteItemByProduct.ProductQuoteWhereProductQuoteItemsByProduct, m.Quote.QuoteItems } },
                new RolePattern(m.ProductQuoteItemByProduct.ValueOrdered) { Steps =  new IPropertyType[] {m.ProductQuoteItemByProduct.ProductQuoteWhereProductQuoteItemsByProduct, m.Quote.QuoteItems } },
            };
