    ...
    public class QuotePriceDerivation : DomainDerivation
    {
        public QuotePriceDerivation(M m) : base(m, new Guid("21c53b93-36a1-4d8c-a003-e34ade4feca6")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new RolePattern(m.Quote.DerivationTrigger),
                new RolePattern(m.Quote.ValidQuoteItems),
                new RolePattern(m.Quote.QuoteItems),
                new RolePattern(m.Quote.Receiver),
                new RolePattern(m.Quote.OrderAdjustments),
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new RolePattern(m.QuoteItem.TotalBasePrice) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem} },
                new RolePattern(m.QuoteItem.TotalDiscount) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalSurcharge) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalPriceAdjustment) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalDiscountAsPercentage) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalSurchargeAsPercentage) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalExVat) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalVat) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalIncVat) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.TotalIrpf) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new RolePattern(m.QuoteItem.GrandTotal) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
            };
