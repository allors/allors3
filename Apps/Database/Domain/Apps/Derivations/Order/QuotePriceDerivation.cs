...
namespace Allors.Database.Domain
{
    ...
    public class QuotePriceDerivation : DomainDerivation
    {
        public QuotePriceDerivation(M m) : base(m, new Guid("21c53b93-36a1-4d8c-a003-e34ade4feca6")) =>
            ...
            {
                new AssociationPattern(this.M.Quote.QuoteState),
                new AssociationPattern(this.M.Quote.DerivationTrigger),
                new AssociationPattern(this.M.Quote.ValidQuoteItems),
                new AssociationPattern(this.M.Quote.QuoteItems),
                new AssociationPattern(this.M.Quote.Receiver),
                new AssociationPattern(this.M.Quote.OrderAdjustments),
                new AssociationPattern(this.M.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new AssociationPattern(this.M.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new AssociationPattern(this.M.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new AssociationPattern(this.M.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment} },
                new AssociationPattern(this.M.QuoteItem.TotalBasePrice) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem} },
                new AssociationPattern(this.M.QuoteItem.TotalDiscount) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalSurcharge) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalPriceAdjustment) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalDiscountAsPercentage) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalSurchargeAsPercentage) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalExVat) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalVat) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalIncVat) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.TotalIrpf) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new AssociationPattern(this.M.QuoteItem.GrandTotal) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
            };
