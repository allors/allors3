...
namespace Allors.Database.Domain
{
    ...
    public class SalesOrderItemPriceDerivation : DomainDerivation
    {
        public SalesOrderItemPriceDerivation(M m) : base(m, new Guid("f8c7f18b-7df0-4ed4-ba1b-30e4c32ee414")) =>
            ...
            {
                new AssociationPattern(this.M.SalesOrderItem.Product),
                new AssociationPattern(this.M.SalesOrderItem.ProductFeature),
                new AssociationPattern(this.M.SalesOrderItem.OrderedWithFeatures),
                new AssociationPattern(this.M.SalesOrderItem.QuantityOrdered),
                new AssociationPattern(this.M.SalesOrderItem.AssignedUnitPrice),
                new AssociationPattern(this.M.SalesOrderItem.DiscountAdjustments),
                new AssociationPattern(this.M.SalesOrderItem.SurchargeAdjustments),
                new AssociationPattern(this.M.SalesOrderItem.VatRate),
                new AssociationPattern(this.M.SalesOrderItem.IrpfRate),
                new AssociationPattern(this.M.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.SalesOrderItem.Class },
                new AssociationPattern(this.M.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.SalesOrderItem.Class },
                new AssociationPattern(this.M.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.SalesOrderItem.Class },
                new AssociationPattern(this.M.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.SalesOrderItem.Class },
                new AssociationPattern(this.M.SalesOrder.BillToCustomer) { Steps =  new IPropertyType[] {m.SalesOrder.SalesOrderItems } },
                new AssociationPattern(this.M.SalesOrder.OrderDate) { Steps =  new IPropertyType[] {m.SalesOrder.SalesOrderItems } },
                new AssociationPattern(this.M.SalesOrder.DerivationTrigger) { Steps =  new IPropertyType[] {m.SalesOrder.SalesOrderItems } },
                new AssociationPattern(this.M.SalesOrderItemByProduct.Product) { Steps =  new IPropertyType[] {m.SalesOrderItemByProduct.SalesOrderWhereSalesOrderItemsByProduct, m.SalesOrder.SalesOrderItems } },
                new AssociationPattern(this.M.SalesOrderItemByProduct.QuantityOrdered) { Steps =  new IPropertyType[] {m.SalesOrderItemByProduct.SalesOrderWhereSalesOrderItemsByProduct, m.SalesOrder.SalesOrderItems } },
                new AssociationPattern(this.M.SalesOrderItemByProduct.ValueOrdered) { Steps =  new IPropertyType[] {m.SalesOrderItemByProduct.SalesOrderWhereSalesOrderItemsByProduct, m.SalesOrder.SalesOrderItems } },
            };
