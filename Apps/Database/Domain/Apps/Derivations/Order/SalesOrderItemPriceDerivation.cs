    ...
    public class SalesOrderItemPriceDerivation : DomainDerivation
    {
        public SalesOrderItemPriceDerivation(M m) : base(m, new Guid("f8c7f18b-7df0-4ed4-ba1b-30e4c32ee414")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new RolePattern(m.SalesOrderItem.OrderedWithFeatures),
                ...
                new RolePattern(m.SalesOrderItem.VatRate),
                new RolePattern(m.SalesOrderItem.IrpfRate),
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.SalesOrderItem.Class },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment}, OfType = m.SalesOrderItem.Class },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.SalesOrderItem.Class },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment}, OfType = m.SalesOrderItem.Class },
                new RolePattern(m.SalesOrder.BillToCustomer) { Steps =  new IPropertyType[] {m.SalesOrder.SalesOrderItems } },
                new RolePattern(m.SalesOrder.OrderDate) { Steps =  new IPropertyType[] {m.SalesOrder.SalesOrderItems } },
                new RolePattern(m.SalesOrder.DerivationTrigger) { Steps =  new IPropertyType[] {m.SalesOrder.SalesOrderItems } },
                new RolePattern(m.SalesOrderItemByProduct.Product) { Steps =  new IPropertyType[] {m.SalesOrderItemByProduct.SalesOrderWhereSalesOrderItemsByProduct, m.SalesOrder.SalesOrderItems } },
                new RolePattern(m.SalesOrderItemByProduct.QuantityOrdered) { Steps =  new IPropertyType[] {m.SalesOrderItemByProduct.SalesOrderWhereSalesOrderItemsByProduct, m.SalesOrder.SalesOrderItems } },
                new RolePattern(m.SalesOrderItemByProduct.ValueOrdered) { Steps =  new IPropertyType[] {m.SalesOrderItemByProduct.SalesOrderWhereSalesOrderItemsByProduct, m.SalesOrder.SalesOrderItems } },
            };
