    ...
    public class PurchaseOrderCreatedDerivation : DomainDerivation
    {
        public PurchaseOrderCreatedDerivation(M m) : base(m, new Guid("ccff8770-2854-4def-8918-37ab823dbf95")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new AssociationPattern(m.PurchaseOrder.AssignedIrpfRegime),
                new AssociationPattern(m.PurchaseOrder.AssignedVatRegime),
                new AssociationPattern(m.PurchaseOrder.AssignedCurrency),
                new AssociationPattern(m.PurchaseOrder.AssignedTakenViaContactMechanism),
