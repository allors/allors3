...
namespace Allors.Database.Domain
{
    ...
    public class ProductQuotePriceDerivation : DomainDerivation
    {
        public ProductQuotePriceDerivation(M m) : base(m, new Guid("21c53b93-36a1-4d8c-a003-e34ade4feca6")) =>
            this.Patterns = new Pattern[]
            {
                new ChangedPattern(m.ProductQuote.DerivationTrigger),
                new ChangedPattern(m.ProductQuote.ValidQuoteItems),
                new ChangedPattern(m.ProductQuote.Receiver),
                new ChangedPattern(m.ProductQuote.OrderAdjustments),
                new ChangedPattern(m.QuoteItem.Product) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem} },
                new ChangedPattern(m.QuoteItem.Quantity) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new ChangedPattern(m.QuoteItem.AssignedUnitPrice) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new ChangedPattern(m.QuoteItem.DiscountAdjustments) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new ChangedPattern(m.QuoteItem.SurchargeAdjustments) { Steps =  new IPropertyType[] {m.QuoteItem.QuoteWhereQuoteItem } },
                new ChangedPattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.QuoteItem.QuoteWhereQuoteItem}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.QuoteItem.QuoteWhereQuoteItem}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.QuoteItem.QuoteWhereQuoteItem}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.QuoteItem.QuoteWhereQuoteItem}, OfType = m.ProductQuote.Class },
                new ChangedPattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.QuoteWhereOrderAdjustment}, OfType = m.ProductQuote.Class },
            };
        ...
        public override void Derive(IDomainDerivationCycle cycle, IEnumerable<IObject> matches)
        {
            ...
            foreach (var @this in matches.Cast<ProductQuote>().Where(v => v.ExistQuoteState && v.QuoteState.IsCreated))
            {
                ...
                foreach (QuoteItem quoteItem in @this.ValidQuoteItems)
                {
                    ...
                    foreach (QuoteItem featureItem in quoteItem.QuotedWithFeatures)
                    {
                        ...
                        this.CalculatePrices(@this, featureItem, currentPriceComponents, quantityOrdered, 0);
                    }

                    this.CalculatePrices(@this, quoteItem, currentPriceComponents, quantityOrdered, 0);
                }
            ...
            decimal totalBasePrice)
        {
            ...
            {
                quoteItemDeriveRoles.UnitBasePrice = unitBasePrice ?? 0;
