...
namespace Allors.Database.Domain
{
    ...
    public class WorkEffortInventoryAssignmentCostOfGoodsSoldDerivation : DomainDerivation
    {
        public WorkEffortInventoryAssignmentCostOfGoodsSoldDerivation(M m) : base(m, new Guid("a6ce76fb-e8dd-4c87-b265-0ff8d0b2b049")) =>
            this.Patterns = new Pattern[]
        {
            new RolePattern(m.WorkEffortInventoryAssignment.InventoryItem),
            new RolePattern(m.WorkEffortInventoryAssignment.Quantity),
        };
