        ...
        public override void Derive(IDomainDerivationCycle cycle, IEnumerable<IObject> matches)
        {
            ...
            foreach (var @this in matches.Cast<WorkTask>())
            {
                ...
                if (!@this.ExistWorkEffortNumber && @this.ExistTakenBy)
                {
                    ...
                    @this.SortableWorkEffortNumber = @this.Session().GetSingleton().SortableNumber(@this.TakenBy.WorkEffortPrefix, @this.WorkEffortNumber, @this.Strategy.Session.Now().Year.ToString());
                }
