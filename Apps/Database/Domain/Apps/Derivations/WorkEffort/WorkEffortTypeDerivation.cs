...
namespace Allors.Database.Domain
{
    ...
    public class WorkEffortTypeDerivation : DomainDerivation
    {
        ...
        {
            new RolePattern(m.WorkEffortType.WorkEffortPartStandards),
            new RolePattern(m.WorkEffortPartStandard.FromDate) { Steps = new IPropertyType[] { m.WorkEffortPartStandard .WorkEffortTypeWhereWorkEffortPartStandard } },
            new RolePattern(m.WorkEffortPartStandard.ThroughDate) { Steps = new IPropertyType[] { m.WorkEffortPartStandard .WorkEffortTypeWhereWorkEffortPartStandard } },
        };
