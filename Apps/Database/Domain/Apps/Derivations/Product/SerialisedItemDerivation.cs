...
namespace Allors.Database.Domain
{
    ...
    public class SerialisedItemDerivation : DomainDerivation
    {
        public SerialisedItemDerivation(M m) : base(m, new Guid("A871B4BB-3285-418F-9E10-5A786A6284DA")) =>
            ...
            {
                new RolePattern(m.SerialisedItem.Name),
                new RolePattern(m.SerialisedItem.ItemNumber),
                new RolePattern(m.SerialisedItem.AcquiredDate),
                new RolePattern(m.SerialisedItem.AcquisitionYear),
                new RolePattern(m.SerialisedItem.SerialNumber),
                new RolePattern(m.SerialisedItem.AssignedSuppliedBy),
                new RolePattern(m.SerialisedItem.PurchaseOrder),
                new RolePattern(m.SerialisedItem.OwnedBy),
                new RolePattern(m.SerialisedItem.RentedBy),
                new RolePattern(m.SerialisedItem.Ownership),
                new RolePattern(m.SerialisedItem.Buyer),
                new RolePattern(m.SerialisedItem.Seller),
                new RolePattern(m.SerialisedItem.SerialisedItemAvailability),
                ...
                new RolePattern(m.QuoteItem.QuoteItemState) { Steps = new IPropertyType[] { m.QuoteItem.SerialisedItem } },
                new AssociationPattern(m.SalesOrderItem.SerialisedItem),
                new RolePattern(m.SalesOrderItem.SalesOrderItemState) { Steps = new IPropertyType[] { m.SalesOrderItem.SerialisedItem } },
                new AssociationPattern(m.WorkEffortFixedAssetAssignment.FixedAsset),
                new RolePattern(m.WorkEffort.WorkEffortState) { Steps = new IPropertyType[] { m.WorkEffort.WorkEffortFixedAssetAssignmentsWhereAssignment, m.WorkEffortFixedAssetAssignment.FixedAsset } },
                new RolePattern(m.Part.ProductType) { Steps = new IPropertyType[] { m.Part.SerialisedItems } },
                new RolePattern(m.ProductType.SerialisedItemCharacteristicTypes) { Steps = new IPropertyType[]{ this.M.ProductType.PartsWhereProductType, m.Part.SerialisedItems } },
                new RolePattern(m.Part.Brand) { Steps = new IPropertyType[] { m.Part.SerialisedItems } },
                new RolePattern(m.Part.Model) { Steps = new IPropertyType[] { m.Part.SerialisedItems } },
                new RolePattern(m.Brand.Name) { Steps = new IPropertyType[] { m.Brand.PartsWhereBrand, m.Part.SerialisedItems } },
                new RolePattern(m.Model.Name) { Steps = new IPropertyType[] { m.Model.PartsWhereModel, m.Part.SerialisedItems } },
            };
