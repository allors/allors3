...
namespace Allors.Database.Domain
{
    ...
    public class PhoneCommunicationDerivation : DomainDerivation
    {
        public PhoneCommunicationDerivation(M m) : base(m, new Guid("6C8EB5C8-1E8C-41CF-B127-53C88E200F65")) =>
            ...
            {
                new RolePattern(m.PhoneCommunication.Subject),
                new RolePattern(m.PhoneCommunication.ToParty),
                new RolePattern(m.Party.PartyName) { Steps = new IPropertyType[] { m.Party.CommunicationEventsWhereToParty}, OfType = m.PhoneCommunication.Class },
            };
