...
namespace Allors.Database.Domain
{
    ...
    public class WebSiteCommunicationsDerivation : DomainDerivation
    {
        public WebSiteCommunicationsDerivation(M m) : base(m, new Guid("F960FDF6-8C3F-4D0F-9E41-48A30CB115F8")) =>
            ...
            {
                new AssociationPattern(m.WebSiteCommunication.Subject),
                new AssociationPattern(m.WebSiteCommunication.ToParty),
                new AssociationPattern(m.Party.PartyName) { Steps = new IPropertyType[] { m.Party.CommunicationEventsWhereToParty}, OfType = m.WebSiteCommunication.Class },
            };
