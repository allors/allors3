    ...
    public class OrganisationDerivation : DomainDerivation
    {
        public OrganisationDerivation(M m) : base(m, new Guid("0379B923-210D-46DD-9D18-9D7BF5ED6FEA")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new RolePattern(m.Employment.Employer),
                ...
                new RolePattern(m.SupplierRelationship.InternalOrganisation),
                ...
                new RolePattern(m.OrganisationContactRelationship.Organisation),
                ...
                new RolePattern(m.SubContractorRelationship.Contractor),
