...
namespace Allors.Database.Domain
{
    ...
    public class LetterCorrespondenceDerivation : DomainDerivation
    {
        public LetterCorrespondenceDerivation(M m) : base(m, new Guid("7C1C3F73-2FE2-4713-8006-682E979E38CE")) =>
            ...
            {
                new RolePattern(m.LetterCorrespondence.Subject),
                new RolePattern(m.LetterCorrespondence.ToParty),
                new RolePattern(m.Party.PartyName) { Steps = new IPropertyType[] { m.Party.CommunicationEventsWhereToParty}, OfType = m.LetterCorrespondence.Class },
            };
