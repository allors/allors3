...
namespace Allors.Database.Domain
{
    ...
    public class SalesInvoiceReadyForPostingDerivation : DomainDerivation
    {
            ...
            this.Patterns = new Pattern[]
        {
            ...
            new RolePattern(m.SalesInvoice.AssignedVatRegime),
            new RolePattern(m.SalesInvoice.AssignedIrpfRegime),
            new RolePattern(m.SalesInvoice.AssignedCurrency),
            new RolePattern(m.SalesInvoice.AssignedVatClause),
            new RolePattern(m.SalesInvoice.AssignedShipToAddress),
            new RolePattern(m.SalesInvoice.AssignedBilledFromContactMechanism),
            new RolePattern(m.SalesInvoice.AssignedBillToContactMechanism),
            new RolePattern(m.SalesInvoice.AssignedBillToEndCustomerContactMechanism),
            new RolePattern(m.SalesInvoice.AssignedShipToEndCustomerAddress),
            new RolePattern(m.SalesInvoice.Locale),
            new RolePattern(m.SalesInvoice.InvoiceDate),
            new RolePattern(m.Party.Locale) { Steps = new IPropertyType[] { this.M.Party.SalesInvoicesWhereBillToCustomer }},
            new RolePattern(m.Party.BillingAddress) { Steps = new IPropertyType[] { this.M.Party.SalesInvoicesWhereBillToCustomer }},
            new RolePattern(m.Party.BillingAddress) { Steps = new IPropertyType[] { this.M.Party.SalesInvoicesWhereBillToEndCustomer }},
            new RolePattern(m.Party.ShippingAddress) { Steps = new IPropertyType[] { this.M.Party.SalesInvoicesWhereShipToCustomer}},
            new RolePattern(m.Party.ShippingAddress) { Steps = new IPropertyType[] { this.M.Party.SalesInvoicesWhereShipToEndCustomer}},
            new RolePattern(m.Organisation.Locale) { Steps = new IPropertyType[] { this.M.Organisation.SalesInvoicesWhereBilledFrom }},
            new RolePattern(m.Party.PreferredCurrency) { Steps = new IPropertyType[] { this.M.Party.SalesInvoicesWhereBillToCustomer }},
            new RolePattern(m.Organisation.PreferredCurrency) { Steps = new IPropertyType[] { this.M.Organisation.SalesInvoicesWhereBilledFrom }},
            new RolePattern(m.Organisation.BillingAddress) { Steps = new IPropertyType[] { this.M.Organisation.SalesInvoicesWhereBilledFrom }},
            new RolePattern(m.Organisation.GeneralCorrespondence) { Steps = new IPropertyType[] { this.M.Organisation.SalesInvoicesWhereBilledFrom }},
        };
