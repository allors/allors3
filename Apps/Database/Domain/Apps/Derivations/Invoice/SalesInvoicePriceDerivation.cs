...
namespace Allors.Database.Domain
{
    ...
    public class SalesInvoicePriceDerivation : DomainDerivation
    {
        ...
        {
            new ChangedPattern(m.SalesInvoice.DerivationTrigger),
            new ChangedPattern(m.SalesInvoice.ValidInvoiceItems),
            new ChangedPattern(m.SalesInvoice.BillToCustomer),
            new ChangedPattern(m.SalesInvoice.OrderAdjustments),
            new ChangedPattern(m.SalesInvoiceItem.Product) { Steps =  new IPropertyType[] {m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem} },
            new ChangedPattern(m.SalesInvoiceItem.ProductFeatures) { Steps =  new IPropertyType[] {m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem} },
            new ChangedPattern(m.SalesInvoiceItem.Quantity) { Steps =  new IPropertyType[] {m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem} },
            new ChangedPattern(m.SalesInvoiceItem.AssignedUnitPrice) { Steps =  new IPropertyType[] {m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem} },
            new ChangedPattern(m.SalesInvoiceItem.DiscountAdjustments) { Steps =  new IPropertyType[] {m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem} },
            new ChangedPattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.SalesInvoiceItem.SurchargeAdjustments) { Steps =  new IPropertyType[] {m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem} },
            new ChangedPattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.SalesInvoiceItem.SalesInvoiceWhereSalesInvoiceItem}, OfType = m.SalesInvoice.Class },
            new ChangedPattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.SalesInvoice.Class },
        };
