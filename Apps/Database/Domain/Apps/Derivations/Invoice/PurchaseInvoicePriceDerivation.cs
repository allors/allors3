    ...
    public class PurchaseInvoicePriceDerivation : DomainDerivation
    {
        public PurchaseInvoicePriceDerivation(M m) : base(m, new Guid("cde03f3a-9151-4bb7-a3a5-5bc238f3cc54")) =>
            this.Patterns = new Pattern[]
            {
                ...
                new RolePattern(m.PurchaseInvoice.DerivationTrigger),
                new RolePattern(m.PurchaseInvoice.ValidInvoiceItems),
                new RolePattern(m.PurchaseInvoice.BilledFrom),
                new RolePattern(m.PurchaseInvoice.OrderAdjustments),
                new RolePattern(m.PurchaseInvoice.InvoiceDate),
                new RolePattern(m.PurchaseInvoiceItem.Part) { Steps =  new IPropertyType[] {m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem } },
                new RolePattern(m.PurchaseInvoiceItem.Quantity) { Steps =  new IPropertyType[] {m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem } },
                new RolePattern(m.PurchaseInvoiceItem.AssignedUnitPrice) { Steps =  new IPropertyType[] {m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem } },
                new RolePattern(m.PurchaseInvoiceItem.DiscountAdjustments) { Steps =  new IPropertyType[] {m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem } },
                new RolePattern(m.PurchaseInvoiceItem.SurchargeAdjustments) { Steps =  new IPropertyType[] {m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem } },
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.DiscountAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.DiscountAdjustment.PriceableWhereDiscountAdjustment, m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.DiscountAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.SurchargeAdjustment.Percentage) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.SurchargeAdjustment.PriceableWhereSurchargeAdjustment, m.PurchaseInvoiceItem.PurchaseInvoiceWherePurchaseInvoiceItem}, OfType = m.PurchaseInvoice.Class },
                new RolePattern(m.SurchargeAdjustment.Amount) { Steps =  new IPropertyType[] {m.OrderAdjustment.InvoiceWhereOrderAdjustment}, OfType = m.PurchaseInvoice.Class },
            };
