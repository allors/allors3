    ...
    public static partial class DatabaseExtensions
    {
        public static void RegisterDerivations(this @IDatabase @this)
        {
            ...
            var derivations = new IDomainDerivation[]
            {
                ...
                new NonSerialisedInventoryItemAvailableToPromiseDerivation(m),
                new NonSerialisedInventoryItemQuantityCommittedOutDerivation(m),
                new NonSerialisedInventoryItemQuantityExpectedInDerivation(m),
                new NonSerialisedInventoryItemQuantityOnHandDerivation(m),
