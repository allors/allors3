    ...
    public static partial class DatabaseExtensions
    {
        public static void RegisterDerivations(this @IDatabase @this)
        {
            ...
            var derivations = new IDomainDerivation[]
            {
                ...
                new WorkEffortInventoryAssignmentCostOfGoodsSoldDerivation(m),
                new WorkEffortInventoryAssignmentDerivedBillableQuantityDerivation(m),
                new WorkEffortInventoryAssignmentUnitSellingPriceDerivation(m),
