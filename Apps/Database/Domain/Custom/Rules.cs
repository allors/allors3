    ...
    public static partial class Rules
    {
        public static Rule[] Create(MetaPopulation m) =>
            new Rule[]
            {
                ...
                new SalesOrderProvisionalDeriveBillToContactMechanismRule(m),
                new SalesOrderProvisionalDeriveBillToEndCustomerContactMechanismRule(m),
                new SalesOrderProvisionalDeriveShipToEndCustomerAddressRule(m),
                new SalesOrderProvisionalDeriveShipFromAddressRule(m),
                new SalesOrderProvisionalDeriveShipToAddressRule(m),
                new SalesOrderProvisionalDeriveShipmentMethodRule(m),
                new SalesOrderPriceRule(m),
                new SalesOrderStateRule(m),
                new SalesOrderItemRule(m),
                new SalesOrderItemProvisionalDeriveShipFromAddressRule(m),
                new SalesOrderItemProvisionalDeriveShipToAddressRule(m),
                new SalesOrderItemProvisionalDeriveShipToPartyRule(m),
                new SalesOrderItemProvisionalDeriveDeliveryDateRule(m),
                new SalesOrderItemProvisionalDeriveVatRegimeRule(m),
                new SalesOrderItemProvisionalDeriveIrpfRegimeRule(m),
                ...
                new PartCategoryDeriveImageRule(m),
                new PartCategoryDeriveTextsRule(m),
                ...
                new SerialisedItemDeriveSearchStringRule(m),
                ...
                new QuoteItemRule(m),
                new QuoteItemCreatedDeriveIrpfRegimeRule(m),
                new QuoteItemCreatedDeriveVatRegimeRule(m),
                ...
                new QuoteRule(m),
                new QuoteDeriveQuoteItemsRule(m),
                new QuoteCreatedDeriveIrpfRegimeRule(m),
                new QuoteCreatedDeriveLocalRule(m),
                new QuoteCreatedDeriveCurrencyRule(m),
                new QuoteCreatedDeriveVatRegimeRule(m),
                ...
                new RequestForQuoteDeriveRequestItemsRule(m),
                new RequestForProposalRule(m),
                new RequestForProposalDeriveRequestItemsRule(m),
                new RequestForInformationDeriveRequestItemsRule(m),
                new RequestForInformationRule(m),
                new RequestForInformationDeriveRequestItemsRule(m),
                new RequestRule(m),
                new RequestDeriveCurrencyRule(m),
                ...
                new PurchaseOrderItemCreatedDeriveIrpfRateRule(m),
                new PurchaseOrderItemCreatedDeriveDeliveryDateRule(m),
                new PurchaseOrderItemCreatedDeriveVatRegimeRule(m),
                ...
                new PurchaseOrderCreatedDeriveLocaleRule(m),
                new PurchaseOrderCreatedDeriveCurrencyRule(m),
                new PurchaseOrderCreatedDeriveVatRegimeRule(m),
                new PurchaseOrderCreatedDeriveIrpfRegimeRule(m),
                new PurchaseOrderCreatedDeriveShipToAddressRule(m),
                new PurchaseOrderCreatedDeriveBillToContactMechanismRule(m),
                new PurchaseOrderCreatedDeriveTakenViaContactMechanismRule(m),
