...
namespace Allors.Database.Domain.Tests
{
    ...
    public class PartCategoryDerivationTests : DomainTest, IClassFixture<Fixture>
    {
        ...
        public void ChangedLocalisedTextTextDeriveName()
        {
            ...
            var partCategory = new PartCategoryBuilder(this.Session).Build();
            this.Session.Derive(false);

            Assert.Null(partCategory.Name);

            partCategory.AddLocalisedName(new LocalisedTextBuilder(this.Session).WithLocale(defaultLocale).WithText("name").Build());
            this.Session.Derive(false);
        ...
        public void ChangedLocalisedTextTextDeriveDescription()
        {
            ...
            partCategory.AddLocalisedDescription(new LocalisedTextBuilder(this.Session).WithLocale(defaultLocale).WithText("description").Build());
            this.Session.Derive(false);
        ...
        public void ChangedCategoryImageDeriveCategoryImage()
        {
            ...
            var partCategory = new PartCategoryBuilder(this.Session).WithName("name").Build();
            this.Session.Derive(false);
        ...
        {
            var partCategory1 = new PartCategoryBuilder(this.Session).Build();
            this.Session.Derive(false);

            var partCategory2 = new PartCategoryBuilder(this.Session).WithPrimaryParent(partCategory1).Build();
            this.Session.Derive(false);
        ...
        public void ChangedPrimaryParentDeriveChildren()
        {
            ...
            var partCategory11 = new PartCategoryBuilder(this.Session).WithPrimaryParent(partCategory1).Build();
            this.Session.Derive(false);
        ...
        public void ChangedSecondaryParentDeriveChildren()
        {
            ...
            var partCategory12 = new PartCategoryBuilder(this.Session).WithSecondaryParent(partCategory1).Build();
            this.Session.Derive(false);
        ...
        {
            var partCategory111 = new PartCategoryBuilder(this.Session).Build();
            this.Session.Derive(false);

            var partCategory11 = new PartCategoryBuilder(this.Session).Build();
            this.Session.Derive(false);
