...
namespace Allors.Workspace.Adapters.Local
{
    ...
    internal sealed class LocalWorkspaceState
    {
        private readonly LocalStrategy strategy;

        private LocalWorkspaceObject workspaceObject;
        private Dictionary<IRelationType, object> changedRoleByRelationType;

        private LocalWorkspaceObject previousWorkspaceObject;
        private Dictionary<IRelationType, object> previousChangedRoleByRelationType;

        internal LocalWorkspaceState(LocalStrategy strategy)
        {
        ...
        private LocalWorkspace Workspace => this.Session.Workspace;
