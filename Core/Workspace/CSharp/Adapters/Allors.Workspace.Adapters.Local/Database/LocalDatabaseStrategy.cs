// <copyright file="LocalDatabaseStrategy.cs" company="Allors bvba">
...
namespace Allors.Workspace.Adapters.Local
{
    ...
    public class LocalDatabaseStrategy : LocalStrategy, IDatabaseStrategy
    {
        ...
        public LocalDatabaseStrategy(LocalSession session, IClass @class, long workspaceId) : base(session, workspaceId, @class) { }

        public LocalDatabaseStrategy(LocalSession session, LocalDatabaseRoles databaseRecord, long workspaceId) : base(session, workspaceId, databaseRecord.Class) => this.DatabaseRole = databaseRecord;

        public LocalDatabaseRoles DatabaseRole { get; private set; }
