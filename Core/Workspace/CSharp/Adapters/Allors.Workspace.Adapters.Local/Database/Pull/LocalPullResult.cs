...
namespace Allors.Workspace.Adapters.Local
{
    ...
    public class LocalPullResult : LocalResult, IPullResult, Database.IProcedureOutput
    {
        ...
        public LocalPullResult(LocalSession session, LocalWorkspace workspace) : base(session)
        {
        ...
        public void Execute(Allors.Workspace.Data.Procedure workspaceProcedure)
        {
            ...
            var localProcedure = new LocalProcedure(this.Transaction, procedure, this.AccessControlLists);
