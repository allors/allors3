...
namespace Tests
{
    ...
    public class PushNewObjectTests : ApiTest, IClassFixture<Fixture>
    {
        ...
        public void WorkspaceX1ObjectInWorkspaceX()
        {
            ...
            {
                NewObjects = new[] { new PushRequestNewObject { ObjectType = this.M.WorkspaceXObject1.IdAsString, NewWorkspaceId = "-1" }, },
            };
        ...
        public void WorkspaceY1ObjectInWorkspaceNone()
        {
            ...
            var pushRequest = new PushRequest
            {
                NewObjects = new[] { new PushRequestNewObject { ObjectType = this.M.WorkspaceYObject1.IdAsString, NewWorkspaceId = "-1" }, },
            };
        ...
        public void WorkspaceNoneObjectInWorkspaceX()
        {
            ...
            var pushRequest = new PushRequest
            {
                NewObjects = new[] { new PushRequestNewObject { ObjectType = this.M.WorkspaceNoneObject1.IdAsString, NewWorkspaceId = "-1" }, },
            };
