...
namespace Allors.Domain.Derivations.Validating
{
    ...
    public static class ChangedAssociationPatternExtensions
    {
        public static void CreatePropertyMatches(this ChangedAssociationPattern @this, IStrategy rootMatch, Matcher matcher)
        {
            ...
            foreach (var match in matches)
            {
                matcher.Add(match, @this.AssociationType);
            }
        }
    }
}
