// <copyright file="ShipmentItemTests.cs" company="Allors bv">
...
namespace Allors.Database.Domain.Tests
{
    ...
    public class ShipmentItemSecurityTests : DomainTest, IClassFixture<Fixture>
    {
        ...
        public void GivenShipmentItem_WhenProcessed_ThenDeleteIsNotAllowed()
        {
            ...
            var acl= this.CreateDatabaseAccessControl()[shipmentItem];
            ...
            acl= this.CreateDatabaseAccessControl()[shipmentItem];
