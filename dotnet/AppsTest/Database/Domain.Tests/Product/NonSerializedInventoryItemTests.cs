// <copyright file="NonSerializedInventoryItemTests.cs" company="Allors bv">
...
namespace Allors.Database.Domain.Tests
{
    ...
    public class NonSerialisedInventoryItemTests : DomainTest, IClassFixture<Fixture>
    {
        ...
        public void GivenInventoryItem_WhenQuantityOnHandIsRaised_ThenSalesOrderItemsWithQuantityShortFalledAreUpdated()
        {
            ...
            new PartyContactMechanismBuilder(this.Transaction).WithParty(customer).WithContactMechanism(mechelenAddress).WithContactPurpose(contactMechanisms.ShippingAddress).WithUseAsDefault(true).Build();
