...
namespace Allors.Database.Configuration
{
    ...
    public class TestsDomainDatabaseServices : DefaultDomainDatabaseServices
    {
        public TestsDomainDatabaseServices(Engine engine, IHttpContextAccessor httpContextAccessor = null) : base(engine, httpContextAccessor) { }
