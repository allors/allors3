...
namespace Allors.Database.Domain
{
    ...
    public class WorkTaskPrintRule : Rule
    {
            ...
            this.Patterns = new Pattern[]
        {
            ...
            m.Brand.RolePattern(v => v.Name, v => v.PartsWhereBrand.Part.SerialisedItems.SerialisedItem.WorkEffortFixedAssetAssignmentsWhereFixedAsset.WorkEffortFixedAssetAssignment.Assignment.WorkEffort.AsWorkTask),
            m.Model.RolePattern(v => v.Name, v => v.PartsWhereModel.Part.SerialisedItems.SerialisedItem.WorkEffortFixedAssetAssignmentsWhereFixedAsset.WorkEffortFixedAssetAssignment.Assignment.WorkEffort.AsWorkTask),
