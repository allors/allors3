...
namespace Allors.Database.Adapters.Sql.Npgsql
{
    ...
    public class Load
    {
        ...
        public Load(Database database, NpgsqlConnection connection, ObjectNotLoadedEventHandler objectNotLoaded, RelationNotLoadedEventHandler relationNotLoaded, LoadOptions options)
        {
