// <copyright file="Invoice.cs" company="Allors bv">
...
namespace Allors.Repository
{
    ...
    #endregion
    public partial interface Invoice : Commentable, Printable, Auditable, Transitional, Deletable, Searchable
    {
        #region Allors
        ...
        #region Allors
        [Id("a7f4d3b2-8c91-4e56-b3d7-2a1f9c8e5d4a")]
        #endregion
        [Derived]
        [Required]
        [Precision(19)]
        ...
        #region Allors
        [Id("e8b3f5d1-7a92-4c6e-9d8f-1b3c5e7a9d2f")]
        #endregion
        [Derived]
        [Precision(19)]
        [Scale(2)]
