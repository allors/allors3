...
namespace Allors.Repository
{
    ...
    #endregion
    public partial interface Order : Printable, Commentable, Localised, Auditable, Transitional, Deletable, Searchable
    {
        #region Allors
        ...
        #region Allors
        [Id("b8e5f2c1-9d73-4a8b-c6e4-3f2a1b7d9e8c")]
        #endregion
        [Derived]
        [Precision(19)]
        [Scale(2)]
        ...
        #region Allors
        [Id("f9c4e6d2-8b73-4d5f-ae1c-2c4d6f8b0e3a")]
        #endregion
        [Derived]
        [Precision(19)]
        [Scale(2)]
