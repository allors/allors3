    ...
    public class NonUnifiedPartSearchStringRule : Rule
    {
        public NonUnifiedPartSearchStringRule(MetaPopulation m) : base(m, new Guid("ebc7bac7-733d-44cf-9850-77d3a3308bfa")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedName.UnifiedProduct, m.NonUnifiedPart),
                m.Part.RolePattern(v => v.LocalisedDescriptions, m.NonUnifiedPart),
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedDescription.UnifiedProduct, m.NonUnifiedPart),
                m.Part.RolePattern(v => v.Keywords, m.NonUnifiedPart),
                m.Part.RolePattern(v => v.LocalisedKeywords, m.NonUnifiedPart),
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedKeyword.UnifiedProduct, m.NonUnifiedPart),
                ...
                m.Party.RolePattern(v => v.DisplayName, v => v.PartsWhereManufacturedBy.Part, m.NonUnifiedPart),
                m.Part.RolePattern(v => v.SuppliedBy, m.NonUnifiedPart),
                m.Party.RolePattern(v => v.DisplayName, v => v.PartsWhereSuppliedBy.Part, m.NonUnifiedPart),
                m.Part.RolePattern(v => v.DefaultFacility, m.NonUnifiedPart),
                m.Facility.RolePattern(v => v.Name, v => v.PartsWhereDefaultFacility.Part, m.NonUnifiedPart),
