...
namespace Allors.Database.Domain
{
    ...
    public class RequestForInformationDeniedPermissionRule : Rule
    {
        ...
        {
            m.RequestForInformation.RolePattern(v => v.TransitionalRevocations),
        ...
        public override void Derive(ICycle cycle, IEnumerable<IObject> matches)
        {
            ...
            foreach (var @this in matches.Cast<RequestForInformation>())
            {
                ...
                var revocation = new Revocations(@this.Strategy.Transaction).RequestForInformationDeleteRevocation;
                if (@this.IsDeletable())
                {
