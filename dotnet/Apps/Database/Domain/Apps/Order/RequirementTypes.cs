// <copyright file="RequirementTypes.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class RequirementTypes
    {
        ...
        private UniquelyIdentifiableCache<RequirementType> Cache => this.cache ??= new UniquelyIdentifiableCache<RequirementType>(this.Transaction);
