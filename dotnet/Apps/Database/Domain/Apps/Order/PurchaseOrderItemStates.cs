// <copyright file="PurchaseOrderItemStates.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class PurchaseOrderItemStates
    {
        ...
        private UniquelyIdentifiableCache<PurchaseOrderItemState> cache;
        ...
        private UniquelyIdentifiableCache<PurchaseOrderItemState> Cache => this.cache ??= new UniquelyIdentifiableCache<PurchaseOrderItemState>(this.Transaction);
