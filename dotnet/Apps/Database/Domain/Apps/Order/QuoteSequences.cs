// <copyright file="QuoteSequences.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class QuoteSequences
    {
        ...
        private UniquelyIdentifiableCache<QuoteSequence> Cache => this.cache ??= new UniquelyIdentifiableCache<QuoteSequence>(this.Transaction);
