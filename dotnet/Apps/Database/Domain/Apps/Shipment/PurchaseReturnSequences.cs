// <copyright file="PurchaseReturnSequences.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class PurchaseReturnSequences
    {
        ...
        private UniquelyIdentifiableCache<PurchaseReturnSequence> Cache => this.cache ??= new UniquelyIdentifiableCache<PurchaseReturnSequence>(this.Transaction);
