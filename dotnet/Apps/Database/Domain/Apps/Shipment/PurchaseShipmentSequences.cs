// <copyright file="PurchaseShipmentSequences.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class PurchaseShipmentSequences
    {
        ...
        private UniquelyIdentifiableCache<PurchaseShipmentSequence> Cache => this.cache ??= new UniquelyIdentifiableCache<PurchaseShipmentSequence>(this.Transaction);
