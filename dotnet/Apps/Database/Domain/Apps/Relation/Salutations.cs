// <copyright file="Salutations.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class Salutations
    {
        ...
        private UniquelyIdentifiableCache<Salutation> Cache => this.cache ??= new UniquelyIdentifiableCache<Salutation>(this.Transaction);
