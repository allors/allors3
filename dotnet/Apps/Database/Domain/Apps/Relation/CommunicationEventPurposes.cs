// <copyright file="CommunicationEventPurposes.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class CommunicationEventPurposes
    {
        ...
        private UniquelyIdentifiableCache<CommunicationEventPurpose> Cache => this.cache ??= new UniquelyIdentifiableCache<CommunicationEventPurpose>(this.Transaction);
