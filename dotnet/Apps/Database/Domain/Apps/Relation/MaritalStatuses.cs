// <copyright file="MaritalStatuses.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class MaritalStatuses
    {
        ...
        private UniquelyIdentifiableCache<MaritalStatus> Cache => this.cache ??= new UniquelyIdentifiableCache<MaritalStatus>(this.Transaction);
