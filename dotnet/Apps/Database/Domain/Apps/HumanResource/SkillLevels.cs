// <copyright file="SkillLevels.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class SkillLevels
    {
        ...
        private UniquelyIdentifiableCache<SkillLevel> Cache => this.cache ??= new UniquelyIdentifiableCache<SkillLevel>(this.Transaction);
