// <copyright file="PositionStatuses.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class PositionStatuses
    {
        ...
        private UniquelyIdentifiableCache<PositionStatus> Cache => this.cache ??= new UniquelyIdentifiableCache<PositionStatus>(this.Transaction);
