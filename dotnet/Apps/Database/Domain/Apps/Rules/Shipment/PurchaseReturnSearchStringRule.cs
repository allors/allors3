    ...
    public class PurchaseReturnSearchStringRule : Rule
    {
        public PurchaseReturnSearchStringRule(MetaPopulation m) : base(m, new Guid("f8313a78-5d46-4e01-854c-af7d43fc878d")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.Party.RolePattern(v => v.DisplayName, v => v.ShipmentsWhereShipFromParty.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.ShipFromAddress, m.PurchaseReturn),
                m.PostalAddress.RolePattern(v => v.DisplayName, v => v.ShipmentsWhereShipFromAddress.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.ShipFromContactPerson, m.PurchaseReturn),
                m.Person.RolePattern(v => v.DisplayName, v => v.ShipmentsWhereShipFromContactPerson.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.ShipFromFacility, m.PurchaseReturn),
                m.Facility.RolePattern(v => v.Name, v => v.ShipmentsWhereShipFromFacility.Shipment, m.PurchaseReturn),
                m.Party.RolePattern(v => v.DisplayName, v => v.ShipmentsWhereShipToParty.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.ShipToAddress, m.PurchaseReturn),
                m.PostalAddress.RolePattern(v => v.DisplayName, v => v.ShipmentsWhereShipToAddress.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.ShipToContactPerson, m.PurchaseReturn),
                m.Person.RolePattern(v => v.DisplayName, v => v.ShipmentsWhereShipToContactPerson.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.ShipToFacility, m.PurchaseReturn),
                m.Facility.RolePattern(v => v.Name, v => v.ShipmentsWhereShipToFacility.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.Carrier, m.PurchaseReturn),
                m.Carrier.RolePattern(v => v.Name, v => v.ShipmentsWhereCarrier.Shipment, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.HandlingInstruction, m.PurchaseReturn),
                m.Shipment.RolePattern(v => v.Store, m.PurchaseReturn),
                m.Store.RolePattern(v => v.Name, v => v.ShipmentsWhereStore.Shipment, m.PurchaseReturn),

                m.ShipmentItem.RolePattern(v => v.ShipmentItemState, v => v.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.ShipmentItem.RolePattern(v => v.Part, v => v.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.Part.RolePattern(v => v.DisplayName, v => v.ShipmentItemsWherePart.ShipmentItem.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.ShipmentItem.RolePattern(v => v.Good, v => v.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.Good.RolePattern(v => v.DisplayName, v => v.ShipmentItemsWhereGood.ShipmentItem.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.ShipmentItem.RolePattern(v => v.ContentsDescription, v => v.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.ShipmentItem.RolePattern(v => v.SerialisedItem, v => v.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.SerialisedItem.RolePattern(v => v.DisplayName, v => v.ShipmentItemsWhereSerialisedItem.ShipmentItem.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.ShipmentItem.RolePattern(v => v.StoredInFacility, v => v.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
                m.Facility.RolePattern(v => v.Name, v => v.ShipmentItemsWhereStoredInFacility.ShipmentItem.ShipmentWhereShipmentItem.Shipment, m.PurchaseReturn),
