    ...
    public class ProposalSearchStringRule : Rule
    {
        public ProposalSearchStringRule(MetaPopulation m) : base(m, new Guid("c4936d90-d5e1-4ae5-822d-47c94865a8f9")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.Person.RolePattern(v => v.DisplayName, v => v.QuotesWhereContactPerson.ObjectType, m.Proposal),
                m.Quote.RolePattern(v => v.SalesTerms, m.Proposal),
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteWhereSalesTerm.ObjectType, m.Proposal),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteWhereSalesTerm.ObjectType, m.Proposal),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteWhereSalesTerm.ObjectType, m.Proposal),
                m.Quote.RolePattern(v => v.Receiver, m.Proposal),
                m.Party.RolePattern(v => v.DisplayName, v => v.QuotesWhereReceiver.ObjectType, m.Proposal),
                m.Quote.RolePattern(v => v.FullfillContactMechanism, m.Proposal),
                m.ContactMechanism.RolePattern(v => v.DisplayName, v => v.QuotesWhereFullfillContactMechanism.ObjectType, m.Proposal),

                m.QuoteItem.RolePattern(v => v.QuoteItemState, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.DerivedIrpfRegime, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.DerivedVatRegime, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.InvoiceItemType, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.InternalComment, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.Authorizer, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.Party.RolePattern(v => v.DisplayName, v => v.QuoteItemsWhereAuthorizer.ObjectType.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.Product, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.ProductFeature, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.SerialisedItem, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.SerialisedItem.RolePattern(v => v.DisplayName, v => v.QuoteItemsWhereSerialisedItem.ObjectType.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.WorkEffort, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.SalesTerms, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteItemWhereSalesTerm.ObjectType.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteItemWhereSalesTerm.ObjectType.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteItemWhereSalesTerm.ObjectType.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.RequestItem, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
                m.QuoteItem.RolePattern(v => v.Details, v => v.QuoteWhereQuoteItem.ObjectType, m.Proposal),
            };
