// <copyright file="PurchaseOrderPriceDerivation.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public class PurchaseOrderPriceRule : Rule
    {
        ...
        public override void Derive(ICycle cycle, IEnumerable<IObject> matches)
        {
            ...
            {
                @this.DerivePurchaseOrderPrice(validation);
            }
        }
    }

    public static class PurchaseOrderPriceRuleExtensions
    {
        public static void DerivePurchaseOrderPrice(this PurchaseOrder @this, IValidation validation)
        {
