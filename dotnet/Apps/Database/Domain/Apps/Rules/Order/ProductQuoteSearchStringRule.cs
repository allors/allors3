    ...
    public class ProductQuoteSearchStringRule : Rule
    {
        public ProductQuoteSearchStringRule(MetaPopulation m) : base(m, new Guid("25e985a3-dd04-403a-ba85-f9b16fd4b474")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteWhereSalesTerm.Quote, m.ProductQuote),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteWhereSalesTerm.Quote, m.ProductQuote),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteWhereSalesTerm.Quote, m.ProductQuote),
                ...
                m.QuoteItem.RolePattern(v => v.SalesTerms, v => v.QuoteWhereQuoteItem.Quote, m.ProductQuote),
                m.QuoteTerm.RolePattern(v => v.TermValue, v => v.QuoteItemWhereSalesTerm.QuoteItem.QuoteWhereQuoteItem.Quote, m.ProductQuote),
                m.QuoteTerm.RolePattern(v => v.TermType, v => v.QuoteItemWhereSalesTerm.QuoteItem.QuoteWhereQuoteItem.Quote, m.ProductQuote),
                m.QuoteTerm.RolePattern(v => v.Description, v => v.QuoteItemWhereSalesTerm.QuoteItem.QuoteWhereQuoteItem.Quote, m.ProductQuote),
