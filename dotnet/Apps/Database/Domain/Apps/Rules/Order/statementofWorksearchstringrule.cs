    ...
    public class StatementOfWorkSearchStringRule : Rule
    {
        public StatementOfWorkSearchStringRule(MetaPopulation m) : base(m, new Guid("ecb0d109-7cdc-4672-9703-62639158b6c0")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.Person.RolePattern(v => v.DisplayName, v => v.QuotesWhereContactPerson.ObjectType, m.StatementOfWork),
                m.Quote.RolePattern(v => v.SalesTerms, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteWhereSalesTerm.ObjectType, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteWhereSalesTerm.ObjectType, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteWhereSalesTerm.ObjectType, m.StatementOfWork),
                m.Quote.RolePattern(v => v.Receiver, m.StatementOfWork),
                m.Party.RolePattern(v => v.DisplayName, v => v.QuotesWhereReceiver.ObjectType, m.StatementOfWork),
                m.Quote.RolePattern(v => v.FullfillContactMechanism, m.StatementOfWork),
                m.ContactMechanism.RolePattern(v => v.DisplayName, v => v.QuotesWhereFullfillContactMechanism.ObjectType, m.StatementOfWork),

                m.QuoteItem.RolePattern(v => v.QuoteItemState, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.DerivedIrpfRegime, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.DerivedVatRegime, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.InvoiceItemType, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.InternalComment, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.Authorizer, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.Party.RolePattern(v => v.DisplayName, v => v.QuoteItemsWhereAuthorizer.ObjectType.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.Product, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.ProductFeature, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.SerialisedItem, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.SerialisedItem.RolePattern(v => v.DisplayName, v => v.QuoteItemsWhereSerialisedItem.ObjectType.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.WorkEffort, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.SalesTerms, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteItemWhereSalesTerm.ObjectType.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteItemWhereSalesTerm.ObjectType.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteItemWhereSalesTerm.ObjectType.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.RequestItem, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
                m.QuoteItem.RolePattern(v => v.Details, v => v.QuoteWhereQuoteItem.ObjectType, m.StatementOfWork),
            };
        ...
        public override void Derive(ICycle cycle, IEnumerable<IObject> matches)
        {
            ...
            {
                @this.DeriveStatementOfWorkSearchString(validation);
            }
        }
    }

    public static class StatementOfWorkSearchStringRuleExtensions
    {
        public static void DeriveStatementOfWorkSearchString(this StatementOfWork @this, IValidation validation)
        {
