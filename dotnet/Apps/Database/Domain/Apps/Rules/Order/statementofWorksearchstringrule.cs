    ...
    public class StatementOfWorkSearchStringRule : Rule
    {
        public StatementOfWorkSearchStringRule(MetaPopulation m) : base(m, new Guid("ecb0d109-7cdc-4672-9703-62639158b6c0")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteWhereSalesTerm.Quote, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteWhereSalesTerm.Quote, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteWhereSalesTerm.Quote, m.StatementOfWork),
                ...
                m.QuoteItem.RolePattern(v => v.SalesTerms, v => v.QuoteWhereQuoteItem.Quote, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermValue, v => v.QuoteItemWhereSalesTerm.QuoteItem.QuoteWhereQuoteItem.Quote, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.TermType, v => v.QuoteItemWhereSalesTerm.QuoteItem.QuoteWhereQuoteItem.Quote, m.StatementOfWork),
                m.SalesTerm.RolePattern(v => v.Description, v => v.QuoteItemWhereSalesTerm.QuoteItem.QuoteWhereQuoteItem.Quote, m.StatementOfWork),
