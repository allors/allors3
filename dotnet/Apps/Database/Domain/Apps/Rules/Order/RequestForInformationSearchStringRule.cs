    ...
    public class RequestForInformationSearchStringRule : Rule
    {
        public RequestForInformationSearchStringRule(MetaPopulation m) : base(m, new Guid("278c8b7b-96d3-48d6-bde0-1442aa466ff5")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.RequestItem.RolePattern(v => v.Comment, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.InternalComment, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.Product, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.ProductFeature, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.SerialisedItem, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.SerialisedItem.RolePattern(v => v.DisplayName, v => v.RequestItemsWhereSerialisedItem.ObjectType.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.Requirements, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.Deliverable, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.Deliverable.RolePattern(v => v.Name, v => v.RequestItemsWhereDeliverable.ObjectType.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.RequestItem.RolePattern(v => v.NeededSkill, v => v.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
                m.Skill.RolePattern(v => v.Name, v => v.NeededSkillsWhereSkill.ObjectType.RequestItemsWhereNeededSkill.ObjectType.RequestWhereRequestItem.ObjectType, m.RequestForInformation),
        ...
        public override void Derive(ICycle cycle, IEnumerable<IObject> matches)
        {
            ...
            {
                @this.DeriveRequestForInformationSearchString(validation);
            }
        }
    }

    public static class RequestForInformationSearchStringRuleExtensions
    {
        public static void DeriveRequestForInformationSearchString(this RequestForInformation @this, IValidation validation)
        {
