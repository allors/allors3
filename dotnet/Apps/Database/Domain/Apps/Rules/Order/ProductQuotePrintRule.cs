    ...
    public class ProductQuotePrintRule : Rule
    {
        public ProductQuotePrintRule(MetaPopulation m) : base(m, new Guid("e74e0eee-7aba-4897-be74-e88b81a9b29f")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.SerialisedItemCharacteristic.AssociationPattern(v => v.PartWhereSerialisedItemCharacteristic, v => v.PartWhereSerialisedItemCharacteristic.Part.QuoteItemsWhereProduct.QuoteItem.QuoteWhereQuoteItem.Quote.AsProductQuote),
                m.SerialisedItemCharacteristic.RolePattern(v => v.Value, v => v.PartWhereSerialisedItemCharacteristic.Part.QuoteItemsWhereProduct.QuoteItem.QuoteWhereQuoteItem.Quote.AsProductQuote),
