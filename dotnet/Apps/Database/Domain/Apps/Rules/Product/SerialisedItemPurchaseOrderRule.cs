...
namespace Allors.Database.Domain
{
    ...
    public class SerialisedItemPurchaseOrderRule : Rule
    {
        public SerialisedItemPurchaseOrderRule(MetaPopulation m) : base(m, new Guid("401c31c7-09cf-4091-aee1-eccc460b8578")) =>
            ...
            {
                m.PurchaseOrder.RolePattern(v => v.ValidOrderItems, v => v.PurchaseOrderItems.ObjectType.SerialisedItem),
                m.PurchaseOrder.RolePattern(v => v.PurchaseOrderState, v => v.PurchaseOrderItems.ObjectType.SerialisedItem),
            };
