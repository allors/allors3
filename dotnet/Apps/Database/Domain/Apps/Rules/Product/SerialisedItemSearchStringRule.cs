    ...
    public class SerialisedItemSearchStringRule : Rule
    {
        public SerialisedItemSearchStringRule(MetaPopulation m) : base(m, new Guid("9d4316ae-3abf-4b6a-839e-1acbcea8995f")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.LocalisedText.RolePattern(v => v.Text, v => v.FixedAssetWhereLocalisedDescription.ObjectType, m.SerialisedItem),
                m.FixedAsset.RolePattern(v => v.Keywords, m.SerialisedItem),
                m.FixedAsset.RolePattern(v => v.LocalisedKeywords, m.SerialisedItem),
                m.LocalisedText.RolePattern(v => v.Text, v => v.FixedAssetWhereLocalisedKeyword.ObjectType, m.SerialisedItem),
                ...
                m.Party.RolePattern(v => v.DisplayName, v => v.PartyFixedAssetAssignmentsWhereParty.ObjectType.FixedAsset.ObjectType, m.SerialisedItem),
                m.AssetAssignmentStatus.RolePattern(v => v.Name, v => v.PartyFixedAssetAssignmentsWhereAssetAssignmentStatus.ObjectType.FixedAsset.ObjectType, m.SerialisedItem),
