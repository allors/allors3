    ...
    public class NonUnifiedPartSearchStringRule : Rule
    {
        public NonUnifiedPartSearchStringRule(MetaPopulation m) : base(m, new Guid("ebc7bac7-733d-44cf-9850-77d3a3308bfa")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.ProductType.RolePattern(v => v.Name, v => v.PartsWhereProductType.ObjectType, m.NonUnifiedPart),
                m.Brand.RolePattern(v => v.Name, v => v.PartsWhereBrand.ObjectType, m.NonUnifiedPart),
                m.Model.RolePattern(v => v.Name, v => v.PartsWhereModel.ObjectType, m.NonUnifiedPart),
