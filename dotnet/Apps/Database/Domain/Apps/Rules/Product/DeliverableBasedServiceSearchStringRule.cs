    ...
    public class DeliverableBasedServiceSearchStringRule : Rule
    {
        public DeliverableBasedServiceSearchStringRule(MetaPopulation m) : base(m, new Guid("957ea986-2db5-42e7-8821-bfb52be13da1")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedName.ObjectType, m.DeliverableBasedService),
                m.UnifiedProduct.RolePattern(v => v.LocalisedDescriptions, m.DeliverableBasedService),
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedDescription.ObjectType, m.DeliverableBasedService),
                ...
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedKeyword.ObjectType, m.DeliverableBasedService),
