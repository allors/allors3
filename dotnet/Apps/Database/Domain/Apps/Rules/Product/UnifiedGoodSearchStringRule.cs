    ...
    public class UnifiedGoodSearchStringRule : Rule
    {
        public UnifiedGoodSearchStringRule(MetaPopulation m) : base(m, new Guid("e2623257-5b06-4a98-a6bc-0dd9d6049a2c")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedName.ObjectType, m.UnifiedGood),
                m.UnifiedProduct.RolePattern(v => v.LocalisedDescriptions, m.UnifiedGood),
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedDescription.ObjectType, m.UnifiedGood),
                m.UnifiedProduct.RolePattern(v => v.Keywords, m.UnifiedGood),
                m.UnifiedProduct.RolePattern(v => v.LocalisedKeywords, m.UnifiedGood),
                m.LocalisedText.RolePattern(v => v.Text, v => v.UnifiedProductWhereLocalisedKeyword.ObjectType, m.UnifiedGood),
                ...
                m.Party.RolePattern(v => v.DisplayName, v => v.PartsWhereManufacturedBy.ObjectType, m.UnifiedGood),
                m.Part.RolePattern(v => v.SuppliedBy, m.UnifiedGood),
                m.Party.RolePattern(v => v.DisplayName, v => v.PartsWhereSuppliedBy.ObjectType, m.UnifiedGood),
                m.Part.RolePattern(v => v.DefaultFacility, m.UnifiedGood),
                m.Facility.RolePattern(v => v.Name, v => v.PartsWhereDefaultFacility.ObjectType, m.UnifiedGood),
