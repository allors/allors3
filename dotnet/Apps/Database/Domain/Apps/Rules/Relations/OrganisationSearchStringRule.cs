    ...
    public class OrganisationSearchStringRule : Rule
    {
        public OrganisationSearchStringRule(MetaPopulation m) : base(m, new Guid("30b64128-3d1c-4426-8f37-ee32423ed1df")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.Qualification.RolePattern(v => v.Name, v => v.PartiesWhereQualification.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.PartySkills, m.Organisation),
                m.Skill.RolePattern(v => v.Name, v => v.PartySkillsWhereSkill.ObjectType.PartiesWherePartySkill.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.PartyClassifications, m.Organisation),
                m.PartyClassification.RolePattern(v => v.Name, v => v.PartiesWherePartyClassification.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.BankAccounts, m.Organisation),
                m.BankAccount.RolePattern(v => v.Iban, v => v.PartyWhereBankAccount.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.CreditCards, m.Organisation),
                m.CreditCard.RolePattern(v => v.CardNumber, v => v.PartyWhereCreditCard.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.DefaultPaymentMethod, m.Organisation),
                m.Party.RolePattern(v => v.DefaultShipmentMethod, m.Organisation),
                m.PartyContactMechanism.RolePattern(v => v.Party, m.Organisation),
                m.ContactMechanism.RolePattern(v => v.DisplayName, v => v.PartyContactMechanismsWhereContactMechanism.ObjectType.Party.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.CurrentPartyRelationships, m.Organisation),
                m.PartyRelationship.RolePattern(v => v.Parties, v => v.PartiesWhereCurrentPartyRelationship.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.InactivePartyRelationships, m.Organisation),
                m.PartyRelationship.RolePattern(v => v.Parties, v => v.PartiesWhereInactivePartyRelationship.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.CurrentContacts, m.Organisation),
                m.Person.RolePattern(v => v.DisplayName, v => v.PartiesWhereCurrentContact.ObjectType, m.Organisation),
                m.Party.RolePattern(v => v.InactiveContacts, m.Organisation),
                m.Person.RolePattern(v => v.DisplayName, v => v.PartiesWhereInactiveContact.ObjectType, m.Organisation),
                ...
                m.IndustryClassification.RolePattern(v => v.Name, v => v.OrganisationsWhereIndustryClassification.ObjectType),
                m.Organisation.RolePattern(v => v.CustomClassifications),
                m.CustomOrganisationClassification.RolePattern(v => v.Name, v => v.OrganisationsWhereCustomClassification.ObjectType),
            };
