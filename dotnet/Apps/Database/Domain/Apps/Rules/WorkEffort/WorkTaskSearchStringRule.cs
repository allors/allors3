    ...
    public class WorkTaskSearchStringRule : Rule
    {
        public WorkTaskSearchStringRule(MetaPopulation m) : base(m, new Guid("e7549768-280e-480b-8f33-c2f3006dc1e5")) =>
            this.Patterns = new Pattern[]
            {
                ...
                m.Organisation.RolePattern(v => v.DisplayName, v => v.WorkEffortsWhereExecutedBy.ObjectType, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.Customer, m.WorkTask),
                m.Party.RolePattern(v => v.DisplayName, v => v.WorkEffortsWhereCustomer.ObjectType, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.Facility, m.WorkTask),
                m.Facility.RolePattern(v => v.Name, v => v.WorkEffortsWhereFacility.ObjectType, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.FullfillContactMechanism, m.WorkTask),
                m.ContactMechanism.RolePattern(v => v.DisplayName, v => v.WorkEffortsWhereFullfillContactMechanism.ObjectType, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.ContactPerson, m.WorkTask),
                m.Person.RolePattern(v => v.DisplayName, v => v.WorkEffortsWhereContactPerson.ObjectType, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.Owner, m.WorkTask),
                m.Person.RolePattern(v => v.DisplayName, v => v.WorkEffortsWhereOwner.ObjectType, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.Priority, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.WorkEffortPurpose, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.Children, m.WorkTask),
                m.WorkEffort.RolePattern(v => v.DeliverablesProduced, m.WorkTask),
                m.Deliverable.RolePattern(v => v.Name, v => v.WorkEffortWhereDeliverablesProduced.ObjectType, m.WorkTask),
                ...
                m.Part.RolePattern(v => v.DisplayName, v => v.InventoryItemsWherePart.ObjectType.WorkEffortInventoryAssignmentsWhereInventoryItem.ObjectType.Assignment.ObjectType, m.WorkTask),
            };
