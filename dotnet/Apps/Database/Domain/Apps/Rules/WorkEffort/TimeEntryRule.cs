...
namespace Allors.Database.Domain
{
    ...
    public class TimeEntryRule : Rule
    {
            ...
            this.Patterns = new Pattern[]
        {
            ...
            m.WorkEffortAssignmentRate.RolePattern(v => v.RateType, v => v.WorkEffort.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.WorkEffortAssignmentRate.RolePattern(v => v.Frequency, v => v.WorkEffort.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.WorkEffortAssignmentRate.RolePattern(v => v.Rate, v => v.WorkEffort.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.Party.RolePattern(v => v.PartyRates, v => v.WorkEffortsWhereCustomer.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.RateType, v => v.PartyWherePartyRate.ObjectType.WorkEffortsWhereCustomer.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.Frequency, v => v.PartyWherePartyRate.ObjectType.WorkEffortsWhereCustomer.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.Rate, v => v.PartyWherePartyRate.ObjectType.WorkEffortsWhereCustomer.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.FromDate, v => v.PartyWherePartyRate.ObjectType.WorkEffortsWhereCustomer.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.ThroughDate, v => v.PartyWherePartyRate.ObjectType.WorkEffortsWhereCustomer.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.Party.RolePattern(v => v.PartyRates, v => v.AsPerson.TimeEntriesWhereWorker, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.RateType, v => v.PartyWherePartyRate.ObjectType.AsPerson.TimeEntriesWhereWorker),
            m.PartyRate.RolePattern(v => v.Frequency, v => v.PartyWherePartyRate.ObjectType.AsPerson.TimeEntriesWhereWorker),
            m.PartyRate.RolePattern(v => v.Rate, v => v.PartyWherePartyRate.ObjectType.AsPerson.TimeEntriesWhereWorker),
            m.PartyRate.RolePattern(v => v.FromDate, v => v.PartyWherePartyRate.ObjectType.AsPerson.TimeEntriesWhereWorker),
            m.PartyRate.RolePattern(v => v.ThroughDate, v => v.PartyWherePartyRate.ObjectType.AsPerson.TimeEntriesWhereWorker),
            m.Party.RolePattern(v => v.PartyRates, v => v.AsOrganisation.WorkEffortsWhereExecutedBy.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.RateType, v => v.PartyWherePartyRate.ObjectType.AsOrganisation.WorkEffortsWhereExecutedBy.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.Frequency, v => v.PartyWherePartyRate.ObjectType.AsOrganisation.WorkEffortsWhereExecutedBy.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.Rate, v => v.PartyWherePartyRate.ObjectType.AsOrganisation.WorkEffortsWhereExecutedBy.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.FromDate, v => v.PartyWherePartyRate.ObjectType.AsOrganisation.WorkEffortsWhereExecutedBy.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
            m.PartyRate.RolePattern(v => v.ThroughDate, v => v.PartyWherePartyRate.ObjectType.AsOrganisation.WorkEffortsWhereExecutedBy.ObjectType.ServiceEntriesWhereWorkEffort, m.TimeEntry),
        };
