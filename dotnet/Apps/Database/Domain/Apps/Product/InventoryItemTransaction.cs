// <copyright file="InventoryItemTransaction.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class InventoryItemTransaction
    {
        ...
        private void SyncInventoryItem()
        {
            ...
            var derivation = this.strategy.Transaction.Database.Services.Get<IDerivationService>().CreateDerivation(this.Strategy.Transaction);
