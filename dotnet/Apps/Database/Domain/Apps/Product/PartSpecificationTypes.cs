// <copyright file="PartSpecificationTypes.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class PartSpecificationTypes
    {
        ...
        private UniquelyIdentifiableCache<PartSpecificationType> Cache => this.cache ??= new UniquelyIdentifiableCache<PartSpecificationType>(this.Transaction);
