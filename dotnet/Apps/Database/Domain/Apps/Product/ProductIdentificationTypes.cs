// <copyright file="ProductIdentificationTypes.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class ProductIdentificationTypes
    {
        ...
        private UniquelyIdentifiableCache<ProductIdentificationType> Cache => this.cache ??= new UniquelyIdentifiableCache<ProductIdentificationType>(this.Transaction);
