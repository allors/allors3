// <copyright file="NonUnifiedParts.cs" company="Allors bvba">
...
{
    public partial class NonUnifiedParts
    {
        ...
        protected override void AppsSecure(Security config)
        {
            ...
            revocations.NonUnifiedPartDeleteRevocation.DeniedPermissions = new[]
            {
