// <copyright file="TimeFrequencies.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class TimeFrequencies
    {
        ...
        private UniquelyIdentifiableCache<TimeFrequency> Cache => this.cache ??= new UniquelyIdentifiableCache<TimeFrequency>(this.Transaction);
