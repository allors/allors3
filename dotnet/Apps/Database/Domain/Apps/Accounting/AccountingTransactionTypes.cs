...
namespace Allors.Database.Domain
{
    ...
    {
        private static readonly Guid AmortizationId = new Guid("70afee4b-1b66-4bf1-af2d-9830c350ef5c");
        private static readonly Guid CapitalizationId = new Guid("abfe1bcb-00a2-43b9-877e-29f4fb612ae3");
        private static readonly Guid CreditLineId = new Guid("d2d99a7f-87a4-4b5c-b9e9-a75d985482f2");
        private static readonly Guid CreditMemoId = new Guid("5f0e7727-ad57-4335-9b08-fa8d6a4b04a0");
        private static readonly Guid DepreciationId = new Guid("684093d8-2681-4f43-af63-048f3f2e89b3");
        private static readonly Guid DisbursementId = new Guid("1ae51a55-6803-4c14-95ac-0d27be006c13");
        private static readonly Guid ExternalId = new Guid("663e5ae5-2bf9-43ca-a2fb-36596784734e");
        private static readonly Guid IncomingPaymentId = new Guid("6a1a350d-2800-44ef-89e8-7296f2a73ad5");
        private static readonly Guid InternalId = new Guid("817ec6c6-7545-4df2-ba5d-e084da7ae644");
        private static readonly Guid InventoryId = new Guid("6f482c8c-61ea-4006-9bbb-a43a6e1c627c");
        private static readonly Guid InventoryReturnId = new Guid("82c6828b-0674-401f-9ba7-82b4b0e8edb2");
        private static readonly Guid ItemVarianceId = new Guid("1e800752-0307-46b5-af2b-eba09a8185e1");
        private static readonly Guid ManufacturingId = new Guid("a34494f3-23a7-4cdf-9883-679e3ab4649e");
        private static readonly Guid NoteId = new Guid("ad9b23db-a521-4b82-8d7a-8bb889c810ef");
        private static readonly Guid ObligationId = new Guid("4a803164-ad6e-401e-918b-4974bedc74ee");
        private static readonly Guid OutgoingPaymentId = new Guid("832016e8-b71a-4fd7-84b0-2a606be4c76c");
        private static readonly Guid PaymentId = new Guid("f4c518d4-b3e2-4481-ae17-58679ee9c645");
        private static readonly Guid PaymentApplicationId = new Guid("b1eb2745-e6d9-45cd-8766-0bb935277a8c");
        private static readonly Guid PeriodClosingId = new Guid("ef61af53-445b-4c75-888b-73e3e062b48e");
        private static readonly Guid PurchaseInvoiceId = new Guid("d4492bdb-2293-4b1e-8453-1da954a9d2d5");
        private static readonly Guid ReceiptId = new Guid("7c84f02b-8163-4045-b48c-8e02bf9dd1bd");
        private static readonly Guid SalesId = new Guid("5cee2f17-2cc7-4130-a2ea-9cfcd2f82f27");
        private static readonly Guid SalesInvoiceId = new Guid("22e61348-7be6-4b2d-a4f7-8a56dd4c02ed");
        private static readonly Guid SalesShipmentId = new Guid("50be7523-e01f-4f04-abe9-c12639ced372");
        private static readonly Guid ShipmentReceiptId = new Guid("eb12db64-5d06-4d06-959b-32daf62661dd");
        private static readonly Guid TaxDueId = new Guid("9b2bda24-d181-4505-b36c-430b58eb60fb");
        ...
        public void Upgrade()
        {
            ...
            {
                v.Name = "";
                localisedName.Set(v, dutchLocale, "");
                v.IsActive = true;
            });
