// <copyright file="JournalTypes.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class JournalTypes
    {
        ...
        private UniquelyIdentifiableCache<JournalType> Cache => this.cache ??= new UniquelyIdentifiableCache<JournalType>(this.Transaction);
