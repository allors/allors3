// <copyright file="DaysOfWeek.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class DaysOfWeek
    {
        ...
        private UniquelyIdentifiableCache<DayOfWeek> Cache => this.cache ??= new UniquelyIdentifiableCache<DayOfWeek>(this.Transaction);
