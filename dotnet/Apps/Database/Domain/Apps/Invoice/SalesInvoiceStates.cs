// <copyright file="SalesInvoiceStates.cs" company="Allors bv">
...
namespace Allors.Database.Domain
{
    ...
    public partial class SalesInvoiceStates
    {
        ...
        private UniquelyIdentifiableCache<SalesInvoiceState> cache;
        ...
        private UniquelyIdentifiableCache<SalesInvoiceState> Cache => this.cache ??= new UniquelyIdentifiableCache<SalesInvoiceState>(this.Transaction);
