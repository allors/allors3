...
namespace Allors.Repository
{
    ...
    public partial interface WorkspaceI1 : Object, WorkspaceI12, S1
    {
        ...
        #endregion
        WorkspaceI1 WorkspaceI1WorkspaceI1Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI12[] WorkspaceI1WorkspaceI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI2[] WorkspaceI1WorkspaceI2Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI2 WorkspaceI1WorkspaceI2Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI12 WorkspaceI1WorkspaceI12Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI2[] WorkspaceI1WorkspaceI2One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC2[] WorkspaceI1WorkspaceC2One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC1 WorkspaceI1WorkspaceC1One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC2[] WorkspaceI1WorkspaceC2Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI1[] WorkspaceI1WorkspaceI1One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI1[] WorkspaceI1WorkspaceI1Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI12 WorkspaceI1WorkspaceI12One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI2 WorkspaceI1WorkspaceI2One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC2 WorkspaceI1WorkspaceC2One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC1[] WorkspaceI1WorkspaceC1One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC1[] WorkspaceI1WorkspaceC1Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI1 WorkspaceI1WorkspaceI1One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC1 WorkspaceI1WorkspaceC1Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceI12[] WorkspaceI1WorkspaceI12One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        WorkspaceC2 WorkspaceI1WorkspaceC2Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I1 WorkspaceI1DatabaseI1Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I12[] WorkspaceI1DatabaseI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I2[] WorkspaceI1DatabaseI2Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I2 WorkspaceI1DatabaseI2Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I12 WorkspaceI1DatabaseI12Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I2[] WorkspaceI1DatabaseI2One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C2[] WorkspaceI1DatabaseC2One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C1 WorkspaceI1DatabaseC1One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C2[] WorkspaceI1DatabaseC2Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I1[] WorkspaceI1DatabaseI1One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I1[] WorkspaceI1DatabaseI1Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I12 WorkspaceI1DatabaseI12One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I2 WorkspaceI1DatabaseI2One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C2 WorkspaceI1DatabaseC2One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C1[] WorkspaceI1DatabaseC1One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C1[] WorkspaceI1DatabaseC1Many2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I1 WorkspaceI1DatabaseI1One2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C1 WorkspaceI1DatabaseC1Many2One { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        I12[] WorkspaceI1DatabaseI12One2Manies { get; set; }
        ...
        [Origin(Origin.Workspace)]
        #endregion
        C2 WorkspaceI1DatabaseC2Many2One { get; set; }
