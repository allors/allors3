...
namespace Allors.Repository
{
    ...
    #endregion
    public partial interface SI12 : S12
    {
        #region Session
        ...
        [Origin(Origin.Session)]
        #endregion
        string SI12AllorsString { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        double SI12AllorsDouble { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        decimal SI12AllorsDecimal { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        DateTime SI12AllorsDateTime { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        bool SI12AllorsBoolean { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SC1[] SI12SC1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SC2[] SI12SC2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SI1[] SI12SI1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SI2[] SI12SI2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SI12[] SI12SI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SI12[] SI12SI12One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SI12[] SessionDependencies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        string WI12AllorsString { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        double WI12AllorsDouble { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        decimal WI12AllorsDecimal { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        DateTime WI12AllorsDateTime { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        bool WI12AllorsBoolean { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WC1[] SI12WC1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WC2[] SI12WC2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI1[] SI12WI1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI2[] SI12WI2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI12[] SI12WI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI12[] SI12WI12One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI12[] WorkspaceDependencies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1[] SI12DatabaseC1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1[] SI12DatabaseC1One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1 SI12DatabaseC1Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1 SI12DatabaseC1One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2 SI12DatabaseC2One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2[] SI12DatabaseC2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2 SI12DatabaseC2Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1 SI12DatabaseI1Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1 SI12DatabaseI1One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1[] SI12DatabaseI1One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1[] SI12DatabaseI1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2[] SI12DatabaseI2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2 SI12DatabaseI2Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2 SI12DatabaseI2One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2[] SI12DatabaseI2One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12[] SI12DatabaseI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12[] SI12DatabaseI12One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12 SI12DatabaseI12One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12 SI12DatabaseI12Many2One { get; set; }
