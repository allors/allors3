...
namespace Allors.Repository
{
    ...
    #endregion
    public partial interface SI1 : Object, SI12, S1
    {
        #region Session
        ...
        [Origin(Origin.Session)]
        #endregion
        SI12[] SI1SI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        string SI1AllorsString { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        DateTime SI1AllorsDateTime { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        decimal SI1AllorsDecimal { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        double SI1AllorsDouble { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        SI12[] SI1SI12One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI12[] SI1WI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        string WI1AllorsString { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        DateTime WI1AllorsDateTime { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        decimal WI1AllorsDecimal { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        double WI1AllorsDouble { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        WI12[] SI1WI12One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1 SI1DatabaseI1Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12[] SI1DatabaseI12Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2[] SI1DatabaseI2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2 SI1DatabaseI2Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12 SI1DatabaseI12Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2[] SI1DatabaseI2One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2[] SI1DatabaseC2One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1 SI1DatabaseC1One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2[] SI1DatabaseC2Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1[] SI1DatabaseI1One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1[] SI1DatabaseI1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12 SI1DatabaseI12One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I2 SI1DatabaseI2One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2 SI1DatabaseC2One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1[] SI1DatabaseC1One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1[] SI1DatabaseC1Many2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I1 SI1DatabaseI1One2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C1 SI1DatabaseC1Many2One { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        I12[] SI1DatabaseI12One2Manies { get; set; }
        ...
        [Origin(Origin.Session)]
        #endregion
        C2 SI1DatabaseC2Many2One { get; set; }
