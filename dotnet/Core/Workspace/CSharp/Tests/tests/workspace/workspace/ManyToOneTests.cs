                ...
                foreach (WorkspaceMode mode1 in Enum.GetValues(typeof(WorkspaceMode)))
                {
                    foreach (WorkspaceMode mode2 in Enum.GetValues(typeof(WorkspaceMode)))
                    {
                        foreach (var contextFactory in this.contextFactories)
                        {
                            ...
                            c1y_1.WorkspaceC1sWhereWorkspaceC1WorkspaceC1Many2One.ShouldEqual(c1x_1, ctx, mode1, mode2);
                ...
                foreach (WorkspaceMode mode1 in Enum.GetValues(typeof(WorkspaceMode)))
                {
                    foreach (WorkspaceMode mode2 in Enum.GetValues(typeof(WorkspaceMode)))
                    {
                        foreach (var contextFactory in this.contextFactories)
                        {
                            ...
                            c1y_1.WorkspaceC1sWhereWorkspaceC1WorkspaceC1Many2One.ShouldNotEqual(c1x_1, ctx, mode1, mode2);
