                ...
                foreach (WorkspaceMode mode1 in Enum.GetValues(typeof(WorkspaceMode)))
                {
                    foreach (DatabaseMode mode2 in Enum.GetValues(typeof(DatabaseMode)))
                    {
                        foreach (var contextFactory in this.contextFactories)
                        {
                            ...
                            c1x_1.WorkspaceC1DatabaseC1Many2Manies.ShouldContain(c1y_1, ctx, mode1, mode2);
                            c1y_1.WorkspaceC1sWhereWorkspaceC1DatabaseC1Many2Many.ShouldContain(c1x_1, ctx, mode1, mode2);
                ...
                foreach (WorkspaceMode mode1 in Enum.GetValues(typeof(WorkspaceMode)))
                {
                    foreach (DatabaseMode mode2 in Enum.GetValues(typeof(DatabaseMode)))
                    {
                        foreach (var contextFactory in this.contextFactories)
                        {
                            ...
                            Assert.Empty(c1x_1.WorkspaceC1DatabaseC1Many2Manies);
                ...
                foreach (WorkspaceMode mode1 in Enum.GetValues(typeof(WorkspaceMode)))
                {
                    foreach (DatabaseMode mode2 in Enum.GetValues(typeof(DatabaseMode)))
                    {
                        foreach (var contextFactory in this.contextFactories)
                        {
                            ...
                            c1x_1.WorkspaceC1DatabaseC1Many2Manies.ShouldNotContain(c1y_1, ctx, mode1, mode2);
                            c1y_1.WorkspaceC1sWhereWorkspaceC1DatabaseC1Many2Many.ShouldNotContain(c1x_1, ctx, mode1, mode2);
                ...
                foreach (WorkspaceMode mode1 in Enum.GetValues(typeof(WorkspaceMode)))
                {
                    foreach (DatabaseMode mode2 in Enum.GetValues(typeof(DatabaseMode)))
                    {
                        foreach (var contextFactory in this.contextFactories)
                        {
                            ...
                            c1x_1.RemoveWorkspaceC1DatabaseC1Many2Many(null);
                            c1x_1.WorkspaceC1DatabaseC1Many2Manies.ShouldContain(c1y_1, ctx, mode1, mode2);
                            c1y_1.WorkspaceC1sWhereWorkspaceC1DatabaseC1Many2Many.ShouldContain(c1x_1, ctx, mode1, mode2);
                            Assert.Single(c1y_1.WorkspaceC1sWhereWorkspaceC1DatabaseC1Many2Many.Where(v => v.Equals(c1x_1)));
