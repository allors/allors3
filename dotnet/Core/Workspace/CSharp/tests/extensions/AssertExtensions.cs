namespace Tests.Workspace
{
    ...
    public static class AssertExtensions
    {
        ...
        public static void ShouldContains(this IEnumerable<object> colletion, object expected, Context context, Mode mode) => Assert.True(colletion.Contains(expected), $"Expected Not Null: [{colletion}, {expected}] on context {context} with mode {mode}");
    }
}
