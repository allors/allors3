...
namespace Allors.Database.Domain.Derivations
{
    ...
    {
        public static void AssertExists(this IValidation @this, IObject association, IRoleType roleType)
        {
        ...
        public static void AssertNotExists(this IValidation @this, IObject association, IRoleType roleType)
        {
            if (association.Strategy.ExistRole(roleType))
            {
        ...
        public static void AssertNonEmptyString(this IValidation @this, IObject association, IRoleType roleType)
        {
            if (association.Strategy.ExistRole(roleType))
            {
        ...
        public static void AssertExistsNonEmptyString(this IValidation @this, IObject association, IRoleType roleType)
        {
            AssertExists(@this, association, roleType);
            AssertNonEmptyString(@this, association, roleType);
        }

        public static void AssertIsUnique(this IValidation @this, IObject association, IRoleType roleType, IChangeSet changeSet)
        {
        ...
        public static void AssertAtLeastOne(this IValidation @this, IObject association, params IRoleType[] roleTypes)
        {
        ...
        public static void AssertExistsAtMostOne(this IValidation @this, IObject association, params IRoleType[] roleTypes)
        {
            var count = 0;
            foreach (var roleType in roleTypes)
            {
        ...
        public static void AssertAreEqual(this IValidation @this, IObject association, IRoleType roleType, IRoleType otherRoleType)
        {
        ...
        public static void AssertExists(this IValidation @this, IObject role, IAssociationType associationType)
        {
