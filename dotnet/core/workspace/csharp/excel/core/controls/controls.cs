...
namespace Application.Excel
{
    ...
    public class Controls
    {
        ...
        internal void Label(int row, int column, IObject sessionObject, IRoleType roleType, IRoleType relationType = null, string numberFormat = null)
        {
        ...
        internal void TextBox(
            int row, int column, IObject sessionObject, IRoleType roleType, IRoleType relationType = null,
            IRoleType displayRoleType = null,
            string numberFormat = null,
            Func<object, dynamic> toDomain = null,
            Func<IObject, dynamic> toCell = null,
            Func<ICell, IObject> factory = null)
        {
        ...
        internal ICell Select(int row, int column, Range options, IObject sessionObject, IRoleType roleType, IRoleType relationType = null,
                    IRoleType displayRoleType = null,
        ...
        private async void Worksheet_CellsChanged(object sender, CellChangedEvent e)
        {
            ...
            foreach (var cell in e.Cells)
            {
                if (this.ControlByCell.TryGetValue(cell, out var control))
                {
                    ...
                    if (control is Label || this.IsGenericStaticContent(control))
                    {
