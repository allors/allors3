// <copyright file="NumbersExceptTests.cs" company="Allors bvba">
...
namespace Allors.Numbers
{
    ...
    public abstract class NumbersExceptTests
    {
        ...
        public void AfterPairWithPair()
        {
            ...
            Assert.Equal(new long[] {4, 5}, num.Enumerate(z));
        }
        ...
        public void OverlappingPairWithPair()
        {
            ...
            Assert.Equal(new long[] {1, 4}, num.Enumerate(z));
        }
        ...
        public void BeforeIntertwinedPairWithPair()
        {
            ...
            Assert.Equal(new long[] {1, 3}, num.Enumerate(z));
        }
        ...
        public void AfterIntertwinedPairWithPair()
        {
            ...
            Assert.Equal(new long[] {2, 4}, num.Enumerate(z));
        }
        ...
        public void TripletPairSameBegin()
        {
            ...
            Assert.Equal(new long[] {3}, num.Enumerate(z));
        }
