...
namespace Allors.Domain
{
    ...
    public class EngagementDerivation : IDomainDerivation
    {
        public Guid Id => new Guid("D2E8DC2A-BB26-4E85-A3DF-6D379A3CD0F0");

        public IEnumerable<Pattern> Patterns { get; } = new[] { new CreatedPattern(M.Engagement.Class) };
