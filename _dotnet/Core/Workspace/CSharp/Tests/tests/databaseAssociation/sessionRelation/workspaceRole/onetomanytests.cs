                    ...
                    foreach (DatabaseMode mode1 in Enum.GetValues(typeof(DatabaseMode)))
                    {
                        foreach (WorkspaceMode mode2 in Enum.GetValues(typeof(WorkspaceMode)))
                        {
                            foreach (var contextFactory in this.contextFactories)
                            {
                                ...
                                c1x_1.SessionWC1One2Manies.ShouldContain(c1y_1, ctx, mode1, mode2);
                                c1y_1.C1WhereSessionWC1One2Many.ShouldEqual(c1x_1, ctx, mode1, mode2);
                    ...
                    foreach (DatabaseMode mode1 in Enum.GetValues(typeof(DatabaseMode)))
                    {
                        foreach (WorkspaceMode mode2 in Enum.GetValues(typeof(WorkspaceMode)))
                        {
                            foreach (var contextFactory in this.contextFactories)
                            {
                                ...
                                c1x_1.SessionWC1One2Manies.ShouldNotContain(c1y_1, ctx, mode1, mode2);
                                c1y_1.C1WhereSessionWC1One2Many.ShouldNotEqual(c1x_1, ctx, mode1, mode2);
