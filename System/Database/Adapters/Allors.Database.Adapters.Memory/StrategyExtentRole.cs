...
namespace Allors.Database.Adapters.Memory
{
    ...
    public sealed class StrategyExtentRole : StrategyExtent
    {
        ...
        public override bool Contains(object value)
        {
            ...
            var valueStrategy = this.associationStrategy.Transaction.InstantiateMemoryStrategy(((IObject)value).Id);
        ...
        internal override void UpgradeTo(ExtentFiltered extent)
        {
            ...
            {
                _ = extent.Filter.AddContains(this.roleType.AssociationType, this.associationStrategy.GetObject());
            }
            else
            {
                _ = extent.Filter.AddEquals(this.roleType.AssociationType, this.associationStrategy.GetObject());
            }
        }
