...
namespace Allors.Database.Domain.Tests.Whist
{
    ...
    public class ScoreboardTests : DomainTest, IClassFixture<Fixture>
    {
        ...
        public void TestAccumulatedScoresWithTwoGames(object data)
        {
            ...
            var game2 = new GameBuilder(this.Transaction).Build();
            scoreboard.AddGame(game2);

            game2.StartDate = this.Transaction.Now();
        ...
        public void TestAccumulatedScoresWithMultipleGameTypes(object data)
        {
            ...
            var game3 = new GameBuilder(this.Transaction).Build();
            scoreboard.AddGame(game3);

            game3.StartDate = this.Transaction.Now();
